 ...
 * @since 1.5
 */
public class BindingSiteSpeciesTypeConstraints extends AbstractConstraintDeclaration{
    ...
    case MULTI_20501:
    {
      func = new ValidationFunction<BindingSiteSpeciesType>() {
        ...
        public boolean check(ValidationContext ctx, BindingSiteSpeciesType bsSt) {
          ...
          if (bsSt.isSetListOfSpeciesTypeInstances() && bsSt.getSpeciesTypeInstanceCount() > 0) {
            return false;
          }
