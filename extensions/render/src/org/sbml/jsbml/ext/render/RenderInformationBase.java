...
public void setBackgroundColor(int backgroundColor) {
  Integer oldBackgroundColor = this.backgroundColor;
 ...
 */
public ColorDefinition createColorDefinition(String id, int value) {
...
/**
 * TODO: if the ID is mandatory for GradientBase objects, 
 * one should also add this methods
 */
//public void removeGradientBase(String id) {
//  getListOfGradientBases().removeFirst(new NameFilter(id));
//}


/**
 * create a new GradientBase element and adds it to the ListOfGradientBases list
 * <p><b>NOTE:</b>
 * only use this method, if ID is not mandatory in GradientBase
 * otherwise use @see createGradientBase(String id)!</p>
 */
/*
public GradientBase createGradientBase() {
  return createGradientBase(null);
}
*/
...
//TODO
/*
public GradientBase createGradientBase(String id) {
  GradientBase field = new GradientBase(id, getLevel(), getVersion());
  addGradientBase(field);
  return field;
}
*/
