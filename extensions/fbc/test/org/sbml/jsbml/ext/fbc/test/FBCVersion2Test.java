...
import org.sbml.jsbml.ext.fbc.GeneProductReference;
...
public class FBCVersion2Test {
  ...
  public FBCVersion2Test() {
    ...
    GeneProductReference gpr = new GeneProductReference("gprf1", "R_ETF transcript 2", level, version);
    gpr.setGeneProduct("gene1");
    and.setLeftChild(gpr);
    gpr = new GeneProductReference(level, version);
    gpr.setGeneProduct("gene2");
    and.setRightChild(gpr);
    ((Or) association).setLeftChild(and);
    ...
    gpr.setGeneProduct("gene2");
    and.setRightChild(gpr);
    ((Or) association).setRightChild(and);
