 ...
 * $URL: svn://svn.code.sf.net/p/jsbml/code/trunk/extensions/layout/src/org/sbml/jsbml/ext/layout/package-info.java $
 * ----------------------------------------------------------------------------
 ...
 * href="http://sbml.org/Community/Wiki/SBML_Level_3_Proposals/Layout">Layout
 * package</a>.
 * </p>
 * <p>
 * There is no formal SBML level 3 proposal but the classes implemented are
 * derived from the <a
