/*
 * $Id:  AdvectionCoefficient.java 15:18:29 draeger $
 * $URL: AdvectionCoefficient.java $
 *
 * 
 *==================================================================================
 ...
 * @version $Rev$
 */
public class AdvectionCoefficient extends AbstractSBase {
	 ...
	 * @param sb
	 */
	public AdvectionCoefficient(SBase sb) {
		super(sb);
		// TODO Auto-generated constructor stub
	}
	...
	public void setCoordinateIndex(int coordinateIndex) {
		this.coordinateIndex = Integer.valueOf(coordinateIndex);
	}
