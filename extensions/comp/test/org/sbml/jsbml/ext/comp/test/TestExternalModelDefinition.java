...
public class TestExternalModelDefinition {
	...
	private void setUpExpectation(String pathFromClassPath) throws URISyntaxException, XMLStreamException, IOException {
		...
		expectedModel = ((CompSBMLDocumentPlugin) SBMLReader.read(expectation).getExtension(CompConstants.shortLabel))
				.getModelDefinition("linked");
	}
	 ...
	 * @throws IOException
	 */
	private void setUpExternalModelDefinition(String pathFromClassPath, String fileName, String modelId)
	...
	/**
	 * WARNING! This test requires an internet connection Tests behaviour for a
	 * reference (https) to an online model that itself references an online model.
	 * 
	 * @throws URISyntaxException
	 * @throws XMLStreamException
	 * @throws IOException
