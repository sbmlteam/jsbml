...
public class TestReadFromFile1 {
  ...
  @Test public void test_read_l1v1_branch()
  {
    SBMLDocument d;
    Model m;
    Compartment c;
    ...
    ud = c.getUnitsInstance(); // TODO : check what the method is performing in libsbml => c.getDerivedUnitDefinition(); API changes ??
    assertTrue( ud.getNumUnits() == 1 );
    assertTrue( ud.getUnit(0).getKind() == Unit.Kind.LITRE ); // TODO : API changes to document
