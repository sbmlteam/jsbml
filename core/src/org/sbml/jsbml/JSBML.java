...
public class JSBML {
   ...
   */
  private static final String jsbmlVersion = "1.1"; // TODO: replace automatically this version number with [BUILD.NUMBER]
  /**
   * 
   */
  ...
  /**
   * String used to know the real parent element for each  child of a {@link ASTNode.Type#FUNCTION_PIECEWISE} ASTNode.
   */
