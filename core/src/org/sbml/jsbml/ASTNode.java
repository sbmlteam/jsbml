...
public class ASTNode extends AbstractTreeNode {
  ...
  public ASTNode getLeftChild() {
    return astnode2 instanceof ASTFunction ? new ASTNode(
        ((ASTFunction) astnode2).getChildAt(0)) : null;
  }
   ...
   * </p>
   * <p>
   * The text-string form of mathematical formulas produced by formulaToString()
   * and read by parseFormula() are simple C-inspired infix notation taken from
   * SBML Level 1. A formula in this text-string form therefore can be handed to
   * a program that understands SBML Level 1 mathematical expressions, or used
   * as part of a formula translation system. The syntax is described in detail
  ...
  public void updateVariables() {
    // TODO: Of no utility anymore as none of the new ci nodes store a direct
    // pointer
