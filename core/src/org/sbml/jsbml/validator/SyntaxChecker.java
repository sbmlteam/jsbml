/*
 * $Id: SyntaxChecker.java 2109 2015-01-05 04:50:45Z andreas-draeger $
 * $URL: svn://svn.code.sf.net/p/jsbml/code/trunk/core/src/org/sbml/jsbml/validator/SyntaxChecker.java $
 * ----------------------------------------------------------------------------
...
public class SyntaxChecker {
  ...
  private void initMetaIdPatterns() {
    ...
    String simpleMetaId = "^[" + letter + underscore + "][" + simpleNameChar + "]*";
    String metaId = "^[" + letter + underscore + "][" + ncNameChar + "]*";
