 ...
 * @since 1.3
 */
public class SBMLErrorPreMessage_en_EN_L2V1 extends SBMLErrorPreMessage {
  ...
  static {
    ...
    contents.put(Integer.toString(SBMLErrorCodes.CORE_10214), "[Although SBML Level 2 Version 1 does not explicitly define the following as an error, other Levels and/or Versions of SBML do.]");
