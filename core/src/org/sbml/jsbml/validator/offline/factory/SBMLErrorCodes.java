...
public interface SBMLErrorCodes {
  ...
  /**
   * Error code 10101:
   * An SBML XML file must use UTF-8 as the character encoding. More precisely,
   * the
   * 'encoding' attribute of the XML declaration at the beginning of the XML
   * data
   * stream cannot have a value other than 'UTF-8'. An example valid declaration
   * is
   ...
   * the
   * SBML namespace. Documents containing unknown elements or attributes placed
   * in
   * the SBML namespace do not conform to the SBML specification. Reference:
   * L3V1
   * Section 4.1
   */
   ...
   * object structure, the data types used by those objects, and the order in
   * which
   ...
   * in the
   * XML 1.0 specification. These rules define the basic structural and
   * syntactic
  ...
  /**
   * Error code 10202:
   * The only permitted MathML 2.0 elements in SBML Level 2 are the following:
   * <cn>,
   * <ci>, <csymbol>, <sep>, <apply>, <piecewise>, <piece>, <otherwise>, <eq>,
   * <neq>,
   * <gt>, <lt>, <geq>, <leq>, <plus>, <minus>, <times>, <divide>, <power>,
   * <root>,
   * <abs>, <exp>, <ln>, <log>, <floor>, <ceiling>, <factorial>, <and>, <or>,
   * <xor>,
   * <not>, <degree>, <bvar>, <logbase>, <sin>, <cos>, <tan>, <sec>, <csc>,
   * <cot>,
   ...
   * <exponentiale>, <semantics>, <annotation>, and <annotation-xml>. Reference:
   * L3V1
   * Section 3.4.1
   */
  ...
  /**
   * Error code 10204:
   * In the SBML subset of MathML 2.0, the MathML attribute 'definitionURL' is
   * only
   * permitted on <csymbol>, <semantics> or <ci> (Level 2 Version 5 and Level 3
   * only). No other MathML elements may have a 'definitionURL' attribute.
   * Reference:
   * L3V1 Section 3.4.1
   */
  ...
  /**
   * Error code 10205:
   * In SBML Level 2, the only values permitted for 'definitionURL' on a
   * <csymbol>
  ...
  /**
   * Error code 10206:
   * In the SBML subset of MathML 2.0, the MathML attribute 'type' is only
   * permitted
   * on the <cn> construct. No other MathML elements may have a 'type'
   * attribute.
  ...
  /**
   * Error code 10207:
   * The only permitted values for the 'type' attribute on MathML <cn> elements
   * are
   * 'e-notation', 'real', 'integer', and 'rational'. Reference: L3V1 Section
   * 3.4.2
   */
   ...
   * 'math' element of a <functionDefinition> or as the first element of a
   * semantics
   * element immediately inside inside the math element of a
   * <functionDefinition>;
   * they may not be used elsewhere in an SBML model. Reference: L3V1 Sections
   * 3.4.1
   * and 4.3.2
   */
  ...
  /**
   * Error code 10211:
   * The values of all arguments to <eq> and <neq> operators must have the same
   * type
  ...
  /**
   * Error code 10212:
   * The types of values within <piecewise> operators must all be consistent:
   * the set
   * of expressions that make up the first arguments of the <piece> and
   * <otherwise>
   * operators within the same <piecewise> operator should all return values of
   * the
   ...
   * identifiers of <functionDefinition>s defined in the SBML model. Reference:
   * L3V1
   * Section 4.3.2
   */
   ...
   * Level 3) <speciesReference> objects defined in the SBML model. (In L2V1,
   * the
  ...
  /**
   * Error code 10216:
   * The 'id' value of a <parameter> defined within a <kineticLaw> can only be
   * used
   * in <ci> elements within the MathML content of that same <kineticLaw>; the
   * identifier is not visible to other parts of the model. Reference: L3V1
   * Sections
   ...
   * expressions:
   * <math> in <kineticLaw>, <stoichiometryMath> in <speciesReference>,
   * <math> in
   * <initialAssignment>, <math> in <assignmentRule>, <math> in <rateRule>,
   * <math> in
   ...
   * function, or in other words, the number of <bvar> elements inside the
   * <lambda>
  ...
  /**
   * Error code 10220:
   * The SBML attribute 'units' may only be added to MathML <cn> elements; no
   * other
   * MathML elements are permitted to have the 'units' attribute. Reference:
   * L3V1
   * Section 3.4.2
   */
  ...
  /**
   * Error code 10221:
   * The value of the SBML attribute 'units' on a MathML <cn> element must be
   * chosen
   * from either the set of identifiers of UnitDefinition objects in the model,
   * or
  ...
  /**
   * Error code 10222:
   * The value of a <ci> element may not be the identifier of a
   * <compartment> with a
  ...
  /**
   * Error code 10302:
   * The value of the 'id' field of every <unitDefinition> must be unique across
   * the
   * set of all <unitDefinition>s in the entire model. Reference: L3V1 Sections
   * 3.3
   * and 4.4
   */
  ...
  /**
   * Error code 10306:
   * An identifier used as the value of 'variable' in an
   * <eventAssignment> cannot
   * also appear as the value of 'variable' in an <assignmentRule>. Reference:
   * L3V1
   * Section 4.12.4
   */
   ...
   * which is
   * a string consisting of the characters 'S', 'B', 'O', ':' followed by
   * exactly
   ...
   * UnitDefinition, the 'units' attribute on Compartment, the 'units' attribute
   * on
   * Parameter, and the 'substanceUnits' attribute on Species) must conform to
   * the
   ...
   * <Species>) must be the identifier of a <UnitDefinition> in the <Model>, or
   * the
   ...
   * MathML
   * math element of every KineticLaw object in a model should be identical to
   * all
  ...
  /**
   * Error code 10511:
   * When the 'variable' in an <assignmentRule> refers to a <compartment>, the
   * units
   * of the rule's right-hand side are expected to be consistent with the units
   * of
  ...
  /**
   * Error code 10512:
   * When the 'variable' in an <assignmentRule> refers to a <species>, the units
   * of
   * the rule's right-hand side are expected to be consistent with the units of
   * the
   ...
   * units of
   * the rule's right-hand side are expected to be consistent with the units
   * declared
  ...
  /**
   * Error code 10514:
   * When the value of the attribute variable in an AssignmentRule object refers
   * to a
   * SpeciesReference object, the unit of measurement associated with the rule's
   * right-hand side should be consistent with the unit of stoichiometry, that
   * is,
  ...
  /**
   * Error code 10521:
   * When the 'variable' in an <initialAssignment> refers to a <compartment>,
   * the
   * units of the <initialAssignment>'s <math> expression are expected to be
   * consistent with the units of that compartment's size. Reference: L3V1
   * Section
   * 4.8
   */
  ...
  /**
   * Error code 10522:
   * When the 'variable' in an <initialAssignment> refers to a <species>, the
   * units
   * of the <initialAssignment>'s <math> expression are expected to be
   * consistent
  ...
  /**
   * Error code 10523:
   * When the 'variable' in an <initialAssignment> refers to a <parameter>, the
   * units
   * of the <initialAssignment>'s <math> expression are expected to be
   * consistent
  ...
  /**
   * Error code 10531:
   * When the 'variable' in a <rateRule> definition refers to a <compartment>,
   * the
   * units of the rule's right-hand side are expected to be of the form _x per
   * time_,
   * where _x_ is either the 'units' in that <compartment> definition, or (in
   * the
   * absence of explicit units declared for the compartment size) the default
   * units
  ...
  /**
   * Error code 10532:
   * When the 'variable' in a <rateRule> definition refers to a <species>, the
   * units
   * of the rule's right-hand side are expected to be of the form _x per time_,
   * where
   * _x_ is the units of that species' quantity, and _time_ refers to the units
   * of
   ...
   * units of the rule's right-hand side are expected to be of the form _x per
   * time_,
   * where _x_ is the 'units' in that <parameter> definition, and _time_ refers
   * to
   * the units of time for the model. Reference: L3V1 Sections 4.7.3, 4.2.4 AND
   * 4.9.4
   */
   ...
   * SpeciesReference object, the unit of measurement associated with the
   * RateRule's
   ...
   * to be
   * the equivalent of _substance per time_. Reference: L3V1 Sections 4.11.7,
   * 4.2.4
   * AND 4.9.4
   */
   ...
   * referenced
   * by a SpeciesReference object), the unit of measurement of the species'
   * substance
   * should be consistent with the unit of extent for the model times the unit
   * of the
   * conversion factor for that species. More precisely, the product of the
   * units
   * indicated by the Model object's extentUnits and the conversionFactor
   * attribute
   ...
   * delay formula are expected to correspond to either the value of 'timeUnits'
   * in
   * the <event> or (if no 'timeUnits' are given), the model's default units of
   * time.
  ...
  /**
   * Error code 10561:
   * When the 'variable' in an <eventAssignment> refers to a <compartment>, the
   * units
   * of the <eventAssignment>'s <math> expression are expected to be consistent
   * with
   ...
   * units of
   * the <eventAssignment>'s <math> expression are expected to be consistent
   * with the
  ...
  /**
   * Error code 10564:
   * When the value of the attribute variable of an EventAssignment object is
   * the
   * identifier of a SpeciesReference object, the unit of measurement associated
   * with
   ...
   * identifier (http://www.biomodels.net/SBO/). In SBML Level 2 prior to
   * Version 4
  ...
  /**
   * Error code 10702:
   * The value of the 'sboTerm' attribute on a <functionDefinition> is expected
   * to be
   ...
   * SBO
   * identifier (http://www.biomodels.net/SBO/) referring to a quantitative
   * parameter
  ...
  /**
   * Error code 10704:
   * The value of the 'sboTerm' attribute on an <initialAssignment> is expected
   * to be
   * an SBO identifier (http://www.biomodels.net/SBO/) referring to a
   * mathematical
   * expression (i.e., terms derived from SBO:0000064, "mathematical expression"
  ...
  /**
   * Error code 10706:
   * The value of the 'sboTerm' attribute on a <constraint> is expected to be an
   * SBO
   * identifier (http://www.biomodels.net/SBO/) referring to a mathematical
   * expression (i.e., terms derived from SBO:0000064, "mathematical expression"
   * ).
  ...
  /**
   * Error code 10707:
   * The value of the 'sboTerm' attribute on a <reaction> is expected to be an
   * SBO
   * identifier (http://www.biomodels.net/SBO/) referring to an occurring entity
   * representation defined in SBO (i.e., terms derived from SBO:0000231,
   * "occurring
   ...
   * (http://www.biomodels.net/SBO/) referring to a participant role. The
   * appropriate
   * term depends on whether the object is a reactant, product or modifier. If a
   * reactant, then it should be a term in the SBO:0000010, "reactant"
   * hierarchy; if
   * a product, then it should be a term in the SBO:0000011, "product"
   * hierarchy; and
  ...
  /**
   * Error code 10709:
   * The value of the 'sboTerm' attribute on a <kineticLaw> is expected to be an
   * SBO
   * identifier (http://www.biomodels.net/SBO/) referring rate law defined in
   * SBO
   * (i.e., terms derived from SBO:0000001, "rate law"). Reference: L3V1 Section
   * 5
   */
  ...
  /**
   * Error code 10711:
   * The value of the 'sboTerm' attribute on an <eventAssignment> is expected to
   * be
   * an SBO identifier (http://www.biomodels.net/SBO/) referring to a
   * mathematical
   * expression (i.e., terms derived from SBO:0000064, "mathematical expression"
  ...
  /**
   * Error code 10712:
   * The value of the 'sboTerm' attribute on a <compartment> is expected to be
   * an SBO
   * identifier (http://www.biomodels.net/SBO/). In SBML Level 2 prior to
   * Version 4
   * it is expected to refer to a participant physical type (i.e., terms derived
   * from
   * SBO:0000236, "participant physical type"); in Versions 4 and above it is
   * expected to refer to a material entity (i.e., terms derived from
   * SBO:0000240,
  ...
  /**
   * Error code 10713:
   * The value of the 'sboTerm' attribute on a <species> is expected to be an
   * SBO
   * identifier (http://www.biomodels.net/SBO/). In SBML Level 2 prior to
   * Version 4
   * it is expected to refer to a participant physical type (i.e., terms derived
  ...
  /**
   * Error code 10714:
   * The value of the 'sboTerm' attribute on a <compartmentType> is expected to
   * be an
   * SBO identifier (http://www.biomodels.net/SBO/). In SBML Level 2 prior to
   * Version
   * 4 it is expected to refer to a participant physical type (i.e., terms
   * derived
   * from SBO:0000236, "participant physical type"); in Versions 4 and above it
   * is
   * expected to refer to a material entity (i.e., terms derived from
   * SBO:0000240,
   * "material entity"). Reference: L3V1 Section 5
  ...
  /**
   * Error code 10715:
   * The value of the 'sboTerm' attribute on a <speciesType> is expected to be
   * an SBO
   * identifier (http://www.biomodels.net/SBO/). In SBML Level 2 prior to
   * Version 4
   * it is expected to refer to a participant physical type (i.e., terms derived
  ...
  /**
   * Error code 10716:
   * The value of the 'sboTerm' attribute on a <trigger> is expected to be an
   * SBO
   * identifier (http://www.biomodels.net/SBO/) referring to a mathematical
   * expression (i.e., terms derived from SBO:0000064, "mathematical expression"
   * ).
  ...
  /**
   * Error code 10718:
   * [Although SBML Level 3 Version 1 does not explicitly define the following
   * as an
   ...
   * following
   * general forms: (1) a complete XHTML document beginning with the element
   * <html>
   * and ending with </html>; (2) the "body" portion of a document beginning
   * with the
   * element <body> and ending with </body>; or (3) XHTML content that is
   * permitted
  ...
  /**
   * Error code 10805:
   * A given SBML object may contain at most one <notes> element. Reference:
   * L3V1
   * Section 3.2
   */
  ...
  /**
   * Error code 20101:
   * The <sbml> container element must declare the XML Namespace for SBML, and
   * this
   ...
   * attribute
   * 'level', and this declaration must be consistent with the XML Namespace
   * declared
  ...
  /**
   * Error code 20104:
   * The <sbml> container element must declare the XML Namespace for any SBML
   * Level 3
   * packages used within the SBML document. This declaration must be consistent
   * with
  ...
  /**
   * Error code 20105:
   * The attribute 'level' on the <sbml> container element must have a value of
   * type
  ...
  /**
   * Error code 20108:
   * The <sbml> object may only have the optional attributes 'metaid' and
   * 'sboTerm'.
  ...
  /**
   * Error code 20201:
   * An SBML document must contain a <model> element. The <model> element is
   * optional
   ...
   * <listOfSpeciesTypes>, <listOfCompartments>, <listOfSpecies>,
   * <listOfParameters>,
  ...
  /**
   * Error code 20203:
   * The <listOf___> containers in a <model> are optional, but if present, the
   * lists
   * cannot be empty. Specifically, if any of the following are present in a
   * <model>,
   * they must not be empty: <listOfFunctionDefinitions>,
   ...
   * one
   * compartment. This is an implication of the fact that the 'compartment'
   * attribute
  ...
  /**
   * Error code 20205:
   * There may be at most one instance of each of the following kind of element
   * in a
   ...
   * Apart from the general Notes and Annotation subobjects permitted on all
   * SBML
   * components, a ListOfCompartments container object may only contain
   * Compartment
   ...
   * Apart from the general Notes and Annotation subobjects permitted on all
   * SBML
   * components, a ListOfSpecies container object may only contain Species
   * objects.
   ...
   * Apart from the general Notes and Annotation subobjects permitted on all
   * SBML
   * components, a ListOfConstraints container object may only contain
   * Constraint
   * objects. Reference: L3V1 Section 4.2.8
   */
   ...
   * the
   * units 'second', 'dimensionless', or the identifier of a UnitDefinition
   * object
  ...
  /**
   * Error code 20218:
   * The value of the attribute 'volumeUnits' on a Model object should be either
   * the
   * units 'litre', 'dimensionless', or the identifier of a UnitDefinition
   * object
   * based on these units or a unit derived from 'metre' (with an exponent of
   * '3').
  ...
  /**
   * Error code 20220:
   * The value of the attribute 'lengthUnits' on a Model object should be either
   * the
   * units 'metre', 'dimensionless', or the identifier of a UnitDefinition
   * object
  ...
  /**
   * Error code 20221:
   * The value of the attribute extentUnits on a Model object should be either
   * the
   * units 'mole', 'item', 'avogadro', 'dimensionless', 'kilogram', 'gram', or
   * the
   ...
   * permitted on a ListOfFunctionDefinitions object. Reference: L3V1 Section
   * 4.2.8
   */
  public static final int CORE_20223   = 20223;
  /**
   * Error code 20224:
   * A ListOfUnitDefinitions object may have the optional attributes 'metaid'
   * and
   * 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
  ...
  /**
   * Error code 20226:
   * A ListOfSpecies object may have the optional attributes 'metaid' and
   * 'sboTerm'.
   * No other attributes from the SBML Level 3 Core namespace are permitted on a
  ...
  /**
   * Error code 20228:
   * A ListOfInitialAssignments object may have the optional attributes 'metaid'
   * and
   * 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
   * permitted on a ListOfInitialAssignments object. Reference: L3V1 Section
   * 4.2.8
   */
  public static final int CORE_20228   = 20228;
  /**
   * Error code 20229:
   * A ListOfRules object may have the optional attributes 'metaid' and
   * 'sboTerm'. No
  ...
  /**
   * Error code 20232:
   * A ListOfEvents object may have the optional attributes 'metaid' and
   * 'sboTerm'.
   * No other attributes from the SBML Level 3 Core namespace are permitted on a
   ...
   * first
   * element within a MathML <apply>, then the <ci>'s value can only be chosen
   * from
   * the set of identifiers of other SBML <functionDefinition>s defined prior to
   * that
   ...
   * functions are not permitted to be recursive. Reference: L3V1 Sections 3.4.3
   * and
   * 4.3.2
   */
   ...
   * first element within a MathML <apply>, then the <ci>'s value can only be
   * the
   * value of a <bvar> element declared in that <lambda>. In other words, all
   * model
   * entities referenced inside a function definition must be passed arguments
   * to
  ...
  /**
   * Error code 20306:
   * A FunctionDefinition object must contain exactly one MathML math element.
   * The
  ...
  /**
   * Error code 20307:
   * FunctionDefinition object must have the required attribute 'id', and may
   * have
   * the optional attributes 'metaid', 'sboTerm' and 'name'. No other attributes
   * from
   * the SBML Level 3 Core namespace are permitted on a FunctionDefinition
   * object.
  ...
  /**
   * Error code 20401:
   * The value of the 'id' attribute in a <unitDefinition> must be of type
   * 'UnitSId'
   * and not be identical to any unit predefined in SBML. Reference: L3V1
   * Section
   * 4.4.2
   */
   ...
   * 'kind'
   * attribute value is 'litre', then its 'exponent' attribute value must be
   * '1'.
   */
   ...
   * If a <unitDefinition> for 'volume' simplifies to a <unit> in which the
   * 'kind'
   * attribute value is 'metre', then its 'exponent' attribute value must be
   * '3'.
   */
  ...
  /**
   * Error code 20410:
   * The value of the 'kind' attribute of a <unit> can only be one of the base
   * units
   * enumerated by 'UnitKind'; that is, the SBML unit system is not hierarchical
   * and
   * user-defined units cannot be defined using other user-defined units.
   * Reference:
   * L3V1 Section 4.4.2
   */
  ...
  /**
   * Error code 20413:
   * The ListOfUnits container object in a UnitDefinition object is optional,
   * but if
  ...
  /**
   * Error code 20419:
   * A UnitDefinition object must have the required attribute 'id' and may have
   * the
   * optional attributes 'metaid', 'sboTerm' and 'name'. No other attributes
   * from the
   * SBML Level 3 Core namespace are permitted on a UnitDefinition object.
   * Reference:
   * L3V1 Section 4.4
   */
  ...
  /**
   * Error code 20421:
   * A Unit object must have the required attributes 'kind', 'exponent', 'scale'
   * and
   * 'multiplier', and may have the optional attributes 'metaid' and 'sboTerm'.
   * No
   * other attributes from the SBML Level 3 Core namespace are permitted on a
   * Unit
   * object. Reference: L3V1 Section 4.4
  ...
  /**
   * Error code 20502:
   * If a <compartment> definition has a 'spatialDimensions' value of '0', then
   * its
   * 'units' attribute must not be set. If the compartment has no dimensions,
   * then no
   ...
   * If a <compartment> definition has a 'spatialDimensions' value of '0', then
   * its
   * 'constant' attribute value must either default to or be set to 'true'. If
   * the
   ...
   * identifier as the value of 'outside', nor can it point to another
   * compartment
   ...
   * enclose compartments that have anything other than zero dimensions
   * themselves.
   */
  ...
  /**
   * Error code 20511:
   * If the attribute 'units' on a Compartment object having a
   * 'spatialDimensions'
   * attribute value of '1' has not been set, then the unit of measurement
   * associated
   * with the compartment's size is determined by the value of the enclosing
   * Model
   * object's 'lengthUnits' attribute. If neither the Compartment object's
   * 'units'
   * nor the enclosing Model object's 'lengthUnits' attributes are set, the unit
   * of
   ...
   * with the compartment's size is determined by the value of the enclosing
   * Model
   * object's 'areaUnits' attribute. If neither the Compartment object's 'units'
   * nor
   ...
   * with the compartment's size is determined by the value of the enclosing
   * Model
   * object's 'volumeUnits' attribute. If neither the Compartment object's
   * 'units'
   * nor the enclosing Model object's 'volumeUnits' attributes are set, the unit
   * of
   * compartment size is undefined. Reference: L3V1 Section 4.5.4
   */
   ...
   * Level
   * 3 Core namespace are permitted on a Compartment object. Reference: L3V1
   * Section
   * 4.5
   */
   ...
   * Compartment object is set, the unit associated with that compartment's size
   * is
  ...
  /**
   * Error code 20601:
   * The value of 'compartment' in a <species> definition must be the identifier
   * of
   * an existing <compartment> defined in the model. Reference: L3V1 Section
   * 4.6.3
   */
  public static final int CORE_20601   = 20601;
  /**
   * Error code 20602:
   * If a <species> definition sets 'hasOnlySubstanceUnits' to 'true', then it
   * must
  ...
  /**
   * Error code 20604:
   * If a <species> located in a <compartment> whose 'spatialDimensions' is set
   * to
  ...
  /**
   * Error code 20605:
   * If a <species> is located in a <compartment> whose 'spatialDimensions' has
   * value
   * '1', then that <species> definition can only set 'spatialSizeUnits' to a
   * value
   * of 'length', 'metre', 'dimensionless', or the identifier of a
   * <unitDefinition>
   ...
   * If a <species> is located in a <compartment> whose 'spatialDimensions' has
   * value
   * '2', then that <species> definition can only set 'spatialSizeUnits' to a
   * value
   * of 'area', 'dimensionless', or the identifier of a <unitDefinition> derived
   * from
   ...
   * If a <species> is located in a <compartment> whose 'spatialDimensions' has
   * value
   * '3', then that <species> definition can only set 'spatialSizeUnits' to a
   * value
   * of 'volume', 'litre', 'dimensionless', or the identifier of a
   * <unitDefinition>
   ...
   * 'initialAmount' because they are mutually exclusive. Reference: L3V1
   * Section
   * 4.6.4
   */
   ...
   * appear
   * as the value of a 'variable' in an <assignmentRule> or a <rateRule>.
   * Reference:
   * L3V1 Section 4.6.6
   */
   ...
   * product in any reaction if that Species also has constant='true'.
   * Reference:
   * L3V1 Section 4.6.6
   */
  ...
  /**
   * Error code 20612:
   * The value of 'speciesType' in a <species> definition must be the identifier
   * of
   ...
   * compartment's identifier and (ii) the <species>' 'speciesType' is set the
   * same
   * value as the 'speciesType' of another <species> that also sets its
   * 'compartment'
  ...
  /**
   * Error code 20614:
   * The 'compartment' attribute in a <species> is mandatory. A
   * <species> definition
   ...
   * then the
   * unit of measurement associated with the species' quantity is determined by
   * the
   * value of the enclosing Model object's 'substanceUnits' attribute. If
   * neither the
   * Species object's 'substanceUnits' attribute nor the enclosing Model
   * object's
   * 'substanceUnits' attribute are set, then the unit of that species' quantity
   * is
  ...
  /**
   * Error code 20701:
   * The 'units' in a <Parameter> definition must be a value chosen from among
   * the
   * following: a predefined unit (e.g., 'substance', 'time', etc.), the
   * identifier
  ...
  /**
   * Error code 20702:
   * If the attribute 'units' on a given Parameter object has not been set, then
   * the
  ...
  /**
   * Error code 20705:
   * A Parameter object referenced by the attribute 'conversionFactor' on a
   * Species
   ...
   * identifier of an existing <compartment>, <species>, or <parameter> defined
   * in
   ...
   * field
   * across the set of <initialAssignment>s in a model. Reference: L3V1 Section
   * 4.8
   */
  public static final int CORE_20802   = 20802;
  /**
   * Error code 20803:
   * The value of a 'symbol' field in any <initialAssignment> definition cannot
   * also
   * appear as the value of a 'variable' field in an <assignmentRule>.
   * Reference:
   * L3V1 Section 4.8
   */
   ...
   * may
   * have the optional attributes 'metaid' and 'sboTerm'. No other attributes
   * from
   * the SBML Level 3 Core namespace are permitted on an InitialAssignment
   * object.
   ...
   * <initialAssignment> definition cannot be the identifier of a
   * <compartment> with
   ...
   * existing <compartment>, <species>, globally-defined <parameter>, or (in
   * Level 3)
  ...
  /**
   * Error code 20903:
   * Any <compartment>, <species>, <parameter>, or (in Level 3)
   * <speciesReference>
   * whose identifier is the value of a 'variable' attribute in an
   * <assignmentRule>,
   ...
   * Any <compartment>, <species>, <parameter>, or (in Level 3)
   * <speciesReference>
   * whose identifier is the value of a 'variable' attribute in an <rateRule>,
   * must
   ...
   * identifier
   * (i.e. the identifier given in the field 'symbol' in <initialAssignment>,
   * the
   * field 'variable' in <assignmentRule>, and the field 'id' on the
   * <kineticLaw>'s
   * enclosing <reaction>). Each of these constructs computes the value using a
   * mathematical formula. The formula for a given identifier cannot make
   * reference
   * to a second identifier whose own definition depends directly or indirectly
   * on
  ...
  /**
   * Error code 20909:
   * A RateRule object must have the required attribute 'variable' and may have
   * the
   * optional attributes 'metaid' and 'sboTerm'. No other attributes from the
   * SBML
  ...
  /**
   * Error code 20910:
   * An AlgebraicRule object may have the optional attributes 'metaid' and
   * 'sboTerm'.
  ...
  /**
   * Error code 20911:
   * The value of a <rateRule> or <assignmentRule>'s 'variable' attribute must
   * not be
   ...
   * <message>. The <message> element is optional, but if present, must follow
   * the
   * <math> element.
   */
  ...
  /**
   * Error code 21006:
   * The XHTML content inside a <constraint>'s <message> element can only take
   * one of
   * the following general forms: (1) a complete XHTML document beginning with
   * the
   * element <html> and ending with </html>; (2) the "body" portion of a
   * document
   * beginning with the element <body> and ending with </body>; or (3) XHTML
   * content
  ...
  /**
   * Error code 21007:
   * A <constraint> object must contain exactly one MathML <math> element. The
   * <math>
  ...
  /**
   * Error code 21009:
   * A <constraint> object may have the optional attributes 'metaid' and
   * 'sboTerm'.
   * No other attributes from the SBML Level 3 Core namespace are permitted on a
   ...
   * either in
   * its <listOfReactants> or its <listOfProducts>. A reaction without any
   * reactant
   * or product species is not permitted, regardless of whether the reaction has
   * any
   ...
   * (<listOfProducts>) in a <reaction> can only contain
   * <speciesReference> elements.
   ...
   * optional, but
   * if present, must be the identifier of an existing Compartment object
   * defined in
   ...
   * and
   * 'fast', and may have the optional attributes 'metaid', 'sboTerm', 'name'
   * and
   ...
   * 'constant', and may have the optional attributes 'metaid', 'sboTerm',
   * 'name'
   * 'id' and 'stoichiometry'. No other attributes from the SBML Level 3 Core
   * namespace are permitted on a <speciesReference> object. Reference: L3V1
   * Section
   * 4.11
   */
   ...
   * 'species'
   * and may have the optional attributes 'metaid', 'sboTerm', 'id' and 'name'.
   * No
   * other attributes from the SBML Level 3 Core namespace are permitted on a
   ...
   * More
   * formally, if a <species> identifier appears in a <ci> element of a
   * <reaction>'s
   * <kineticLaw> formula, that same identifier must also appear in at least one
   * <speciesReference> or <modifierSpeciesReference> in the
   * <reaction> definition.
   ...
   * <listOfParameters>. The <listOfParameters> is optional, but if present,
   * must
   * follow <math>.
   */
  ...
  /**
   * Error code 21123:
   * If present, the <listOfParameters> in a <kineticLaw> must not be an empty
   * list.
   * Reference: L3V1 Section 4.11
   */
   ...
   * SBML
   * Level 1 and Level 2 Version 1, has been removed as of SBML Level 2 Version
   * 2. In
   * SBML Level 2 Version 2, the substance units of a reaction rate expression
   * are
   ...
   * Level 1
   * and Level 2 Version 1, has been removed as of SBML Level 2 Version 2. In
   * SBML
   * Level 2 Version 2, the time units of a reaction rate expression are those
   * of the
  ...
  /**
   * Error code 21130:
   * A KineticLaw object must contain exactly one MathML <math> element. The
   * <math>
   ...
   * <reaction>'s <stoichiometryMath> formula, that same identifier must also
   * appear
  ...
  /**
   * Error code 21150:
   * A ListOfSpeciesReferences object may have the optional attributes 'metaid'
   * and
   * 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
  ...
  /**
   * Error code 21152:
   * The value of the 'fast' attribute should be 'false', as the attribute has
   * been
   * deprecated.
   */
  ...
  /**
   * Error code 21172:
   * A LocalParameter object must have the required attribute 'id' and may have
   * the
   * optional attributes 'metaid', 'sboTerm', 'name', 'value' and 'units'. No
   * other
  ...
  /**
   * Error code 21206:
   * If an <event>'s 'useValuesFromTriggerTime' attribute has the value 'false',
   * then
   * the <event> must contain a <delay> element. The implication of
   * 'useValuesFromTriggerTime=false' is that there is a delay between the time
   * of
   * trigger and the time of value assignments performed by the <event>.
   * Reference:
   * L3V1 Section 4.12
   */
  ...
  /**
   * Error code 21207:
   * If an Event object contains a Delay subobject, then the Event must have a
   * value
   ...
   * the
   * identifier of a <compartment>, <species>, model-wide
   ...
   * <eventAssignment> must have a value of 'false' for its 'constant'
   * attribute.
  ...
  /**
   * Error code 21221:
   * An Event object may contain at most one Delay object. Reference: L3V1
   * Section
   * 4.12
   */
  ...
  /**
   * Error code 21224:
   * A ListOfEventAssignments object may have the optional attributes 'metaid'
   * and
   * 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
   ...
   * 'name'. No other attributes from the SBML Level 3 Core namespace are
   * permitted
  ...
  /**
   * Error code 21227:
   * A Delay object may have the optional attributes 'metaid' and 'sboTerm'. No
   * other
   * attributes from the SBML Level 3 Core namespace are permitted on a Delay
   * object.
   * Reference: L3V1 Section 4.12
   */
  ...
  /**
   * Error code 21230:
   * An Event object may contain at most one Priority object. Reference: L3V1
   * Section
   * 4.12
   */
  ...
  /**
   * Error code 21231:
   * An Priority object must contain exactly one MathML <math> element. The
   * <math>
   * element is optional in L3V2 and beyond. Reference: L3V1 Section 4.12
   */
  ...
  /**
   * Error code 80501:
   * As a principle of best modeling practice, the size of a
   * <compartment> should be
   * set to a value rather than be left undefined. Doing so improves the
   * portability
   * of models between different simulation and analysis systems, and helps make
   * it
  ...
  /**
   * Error code 80601:
   * As a principle of best modeling practice, the <species> should set an
   * initial
   * value (amount or concentration) rather than be left undefined. Doing so
   * improves
  ...
  /**
   * Error code 80701:
   * As a principle of best modeling practice, the units of a <parameter> should
   * be
   * declared rather than be left undefined. Doing so improves the ability of
   * software to check the consistency of units and helps make it easier to
   * detect
  ...
  /**
   * Error code 80702:
   * As a principle of best modeling practice, the <parameter> should set an
   * initial
   * value rather than be left undefined. Doing so improves the portability of
   * models
   * between different simulation and analysis systems, and helps make it easier
   * to
  ...
  /**
   * Error code 81121:
   * In SBML's simple symbol system, there is no separation of symbols by class
   * of
   * object; consequently, inside the kinetic law mathematical formula, the
   * value of
   * a local parameter having the same identifier as a species or compartment or
   * other global model entity will override the global value. Modelers may wish
   * to
  ...
  /**
   * Error code 90001:
   * Use of SBML Level 1 Version 1 is not recommended and conversion is not
   * supported
   * by libSBML.
   */
  ...
  /**
   * Error code 91010:
   * A <unit> containing multipliers or offsets cannot be represented in SBML
   * Level
   * 1.
   */
  ...
  /**
   * Error code 91011:
   * A <species> that does not identify its compartment cannot be represented in
   * SBML
   * Level 1.
   */
  ...
  /**
   * Error code 91012:
   * The information represented by the value of a 'spatialSizeUnit' attribute
   * on a
  ...
  /**
   * Error code 91014:
   * SBML Level 2 Version 4 removed the requirement that all units be
   * consistent.
   * This model contains units that produce inconsistencies and thus conversion
   * to
  ...
  /**
   * Error code 91015:
   * This model contains conversion factors and thus conversion to earlier
   * levels is
   * not supported.
   */
  ...
  /**
   * Error code 91018:
   * Conversion to SBML Levels 1 and 2 requires that any global units must refer
   * to a
   ...
   * concentration cannot be correctly interpreted in SBML Level 1 without
   * alteration
   ...
   * <initialAssignments> in the original model have been replaced by
   * appropriate
   * values.
   */
  ...
  /**
   * Error code 92004:
   * <compartmentType> definitions cannot be represented in SBML Level 2 Version
   * 1.
   */
  ...
  /**
   * Error code 92006:
   * The 'id' attribute value of a <speciesReference> cannot be represented
   * directly
  ...
  /**
   * Error code 92007:
   * The implication of 'useValuesFromTriggerTime=false' is that there is a
   * delay
   * between the time of trigger and the time of value assignments performed by
   * the
   * <event>. This interpretation is not supported by SBML Level 2 versions
   * prior to
  ...
  /**
   * Error code 92009:
   * Models in SBML Level 2 Versions 1-4 can only represent compartments with
   * integer
   ...
   * The 'offset' attribute on <unit> previously available in SBML Level 2
   * Version 1,
   * has been removed as of SBML Level 2 Version 2. (References: L2V2 Section
   * 4.4.)
   */
   ...
   * SBML Level 2 Version 2, the substance units of a reaction rate expression
   * are
   * those of the global 'substance' units of the model. (References: L2V2
   * Section
   * 4.13.5.)
   */
  ...
  /**
   * Error code 93006:
   * In SBML Level 2 prior to Version 4 the value of the 'sboTerm' attribute on
   * a
   * <model> is expected to be a term derived from SBO:0000004,
   * "modeling framework";
   ...
   * (References: L2V2 Section 4.2.1; L2V3 Sections 4.2.2 and 5; L2V4 Sections
   * 4.2.2
   * and 5)
   */
  ...
  /**
   * Error code 93008:
   * SBML Level 2 Version 4 removed the requirement that all sboTerms be drawn
   * from a
   * given branch of SBO (http://www.biomodels.net/SBO/). This model contains
   * sboTerms that produce inconsistencies and thus conversion to Level 2
   * Version 2
   ...
   * multiple top level elements using the same namespace. This is no longer
   * valid.
   * (References: L2V2 Section 3.3.3; L2V3 Section 3.2.4; L2V4 Section 3.2.4.)
   * Any
   * duplicate top level elements will be placed inside a new top level element
   * named
   ...
   * and Level 2 Version 1, has been removed as of SBML Level 2 Version 2. In
   * SBML
   * Level 2 Version 3, the time units of a reaction rate expression are those
   * of the
   * global 'time' units of the model. (References: L2V2 Section 4.13.5.)
   */
   ...
   * Level 1 and Level 2 Version 1, has been removed as of SBML Level 2 Version
   * 2. In
   * SBML Level 2 Version 3, the substance units of a reaction rate expression
   * are
   * those of the global 'substance' units of the model. (References: L2V2
   * Section
   * 4.13.5.)
  ...
  /**
   * Error code 96002:
   * <compartmentType> definitions cannot be represented in SBML Level 3 Version
   * 1.
   */
  ...
  /**
   * Error code 96010:
   * The 'outside' attribute on <compartment>, previously available in SBML
   * Level 2
  ...
  /**
   * Error code 99101:
   * The level and version specified for the document must be consistent with a
   * valid
   * published SBML specification. These are Level 1, Versions 1 and 2; Level 2,
   * Versions 1, 2, 3 and 4; and Level 3, Version 1. If newer levels or versions
   * of
  ...
  /**
   * Error code 99106:
   * The math field of an assignment rule structure can contain any identifier
   * in a
   * MathML <ci> element except for the following: (a) identifiers for which
   * there
   * exists a subsequent assignment rule, and (b) the identifier for which the
   * rule
   ...
   * and
   * defines the attribute named 'required'. A value of required=true indicates
   * that
   * interpreting the package is necessary for complete mathematical
   * interpretation
   * of the model. (L3V1 Section 4.1.2) This instance of libSBML version 5
   * cannot
   ...
   * Every SBML Level 3 package is identified uniquely by an XML namespace URI
   * and
   * defines the attribute named 'required'. LibSBML has detected what appears
   * to be
  ...
  /**
   * Error code 99109:
   * The 'required' attribute for this package is expected to be 'false' as
   * there is
  ...
  /**
   * Error code 99127:
   * A KineticLaw's substanceUnits must be 'substance', 'item', 'mole', or the
   * id of
  ...
  /**
   * Error code 99129:
   * In a Level 1 model, only predefined functions are permitted within the
   * formula.
   * (L1V2 Appendix C)
   */
  ...
  /**
   * Error code 99224:
   * Invalid MathML. The body of a <math> tag or the body of a <lambda> element
   * must
   * begin with one of the following: <cn>, <ci>, <csymbol>, <apply>,
   * <piecewise>,
   ...
   * attribute must refer to a unit defined in SBML or be the id of a
   * UnitDefinition
   * in the model.
   */
   ...
   * Unfortunately, some attributes were not present or correct and the
   * resulting
   ...
   * Unfortunately, some attributes were not present or correct and the
   * resulting
   * ModelHistory object is NULL. Thus it will fail to produce the annotation.
   * This
   * functionality will be improved in later versions of libSBML. Reference:
   * L3V1
   * Section 6.3
  ...
  /**
   * Error code 99406:
   * An annotation must contain elements; with each top-level element placed in
   * a
  ...
  /**
   * Error code 99407:
   * The specified annotation RELATION element does not permit nested elements.
   * This
   ...
   * time
   * should be consistent with the global time units of the model. In models
   * where
   * the 'timeUnits' attribute has not been declared, libSBML does not yet have
   * the
   ...
   * of
   * extent should be consistent with the global extent units of the model. In
   * models
   * where the 'extentUnits' attribute has not been declared, libSBML does not
   * yet
   * have the functionality to verify accurately the consistency of the units in
   * such
   * expressions.
   */
   ...
   * species
   * or parameter, it is necessary to know the units of the object to establish
   * unit
   * consistency. In models where the units of an object have not been declared,
   * libSBML does not yet have the functionality to accurately verify the
   * consistency
  ...
  /**
   * Error code 99901:
   * The 'spatialDimensions' attribute on <compartment> was not available in
   * SBML
  ...
  /**
   * Error code 99902:
   * The 'compartmentType' attribute on <compartment> was not available in SBML
   * Level
   * 1 or SBML Level 2 Version 1. In order for the internal representation of a
   * <compartment> to be correct, the value for the compartmentType member
   * variable
  ...
  /**
   * Error code 99903:
   * The 'constant' attribute on <compartment> and <parameter> was not available
   * in
   * SBML Level 1. In order for the internal representation of <compartment> and
   * <parameter> to be correct, the value for the constant member variable
   * should be
  ...
  /**
   * Error code 99904:
   * The 'metaid' attribute on all <SBase> objects was not available in SBML
   * Level 1.
  ...
  /**
   * Error code 99905:
   * The 'sboTerm' attribute on <compartment>, <compartmentType> <delay>,
   * <species>,
   * <speciesType>, <stoichiometryMath>, <trigger> <unit> and
   * <unitDefinition> was
  ...
  /**
   * Error code 99908:
   * The <compartmentType> component was introduced in SBML Level 2 Version 2.
   * In
  ...
  /**
   * Error code 99909:
   * The <constraint> component was introduced in SBML Level 2 Version 2. In
   * order
  ...
  /**
   * Error code 99910:
   * The <event> component was introduced in SBML Level 2 Version 1. In order
   * for the
   * internal representation of a <model> to be correct, the
   ...
   * <kineticLaw>, <model>, <parameter>, <reaction> <rule> and
   * <speciesReferenece>
  ...
  /**
   * Error code 99913:
   * The <initialAssignment> component was introduced in SBML Level 2 Version 2.
   * In
  ...
  /**
   * Error code 99914:
   * An <algebraicRule> does not assign a value to a particular variable and
   * does not
  ...
  /**
   * Error code 99915:
   * The 'units' attribute on <rule> was only applicable to a <parameterRule> in
   * SBML
   * Level 1. In order for the internal respresentation of a <rule> to be
   * correct,
   ...
   * order for the internal respresentation of <species> to be correct, the
   * value for
  ...
  /**
   * Error code 99917:
   * The 'spatialSizeUnits' attribute on <species> was not available in SBML
   * Level 1.
  ...
  /**
   * Error code 99918:
   * The 'speciesType' attribute on <species> was not available in SBML Level 1
   * or
   * SBML Level 2 Version 1. In order for the internal respresentation of a
   * <species>
   * to be correct, the value for the speciesType member variable should be not
   * be
   * set.
   */
  ...
  /**
   * Error code 99919:
   * The 'hasOnlySubstanceUnits' attribute on <species> was not available in
   * SBML
   * Level 1. In order for the internal respresentation of a <species> to be
   * correct,
  ...
  /**
   * Error code 99920:
   * The 'id' attribute on <speciesReference> was not available in SBML Level 1
   * or
   * SBML Level 2 Version 1. In order for the internal respresentation of a
   * <speciesReference> to be correct, the value for the id member variable
   * should be
   * not be set.
   */
  ...
  /**
   * Error code 99921:
   * The 'name' attribute on <speciesReference> was not available in SBML Level
   * 1 or
   * SBML Level 2 Version 1. In order for the internal respresentation of a
   * <speciesReference> to be correct, the value for the name member variable
   * should
   * be not be set.
   */
  ...
  /**
   * Error code 99922:
   * The <speciesType> component was introduced in SBML Level 2 Version 2. In
   * order
  ...
  /**
   * Error code 99923:
   * The <stoichiometryMath> component on a <speciesReference> was introduced in
   * SBML
   * Level 2. In order for the internal respresentation of a
   * <speciesReference> to be
   * correct, the <stoichiometryMath> component should be 'NULL'.
   */
  public static final int CORE_99923   = 99923;
  /**
   * Error code 99924:
   * The 'multiplier' attribute on <unit> was not available in SBML Level 1. In
   * order
   * for the internal respresentation of a <unit> to be correct, the value for
   * the
  ...
  /**
   * Error code 99925:
   * The 'offset' attribute on <unit> was only available in SBML Level 2 Version
   * 1.
   * In order for the internal respresentation of a <unit> to be correct, the
   * value
  ...
  /**
   * Error code 99926:
   * The 'spatialDimensions' attribute on <compartment> was left unset on the
   * SBML
   ...
   * specification for SBML Level 3, an SBML document must declare the use of
   * the
   * following XML Namespace:
   * 'http://www.sbml.org/sbml/level3/version1/comp/version1' Reference: L3V1
   * Comp V1
   * Section 3.1
   */
   ...
   * Hierarchical Model Composition package must be declared either implicitly
   * or
   ...
   * specification.) Within a <model> or <modelDefinition> object, the values of
   * the
   * attributes id and comp:id on every instance of the following classes of
   * objects
   * must be unique across the set of all id and comp:id attribute values of all
   * such
   * objects in a model: the model itself, plus all contained
   * <functionDefinition>,
   * <compartment>, <species>, <reaction>, <speciesReference>,
   * <modifierSpeciesReference>, <event>, and <parameter> objects, plus the
   * <submodel> and <deletion> objects defined by the Hierarchical Model
   * Composition
   * package, plus any objects defined by any other package with 'package:id'
   * attributes defined as falling in the 'SId' namespace. Reference: L3V1 Comp
   * V1
   * Section 3.9
   */
   ...
   * <model>, <modelDefinition>, and <externalModelDefinition> objects must be
   * unique
   * across the set of all 'id' and 'comp:id' attribute values of such objects
   * in the
  ...
  /**
   * Error code 1010303:
   * Within <model> and <modelDefinition> objects inside an SBML document, the
   * value
   * of the attribute 'comp:id' on every instance of a <port> object must be
   * unique
  ...
  /**
   * Error code 1010304:
   * The value of a comp:id attribute must always conform to the syntax of the
   * SBML
   ...
   * <replacedBy> objects must always conform to the syntax of the SBML data
   * type
   ...
   * always conform to the syntax of the SBML data type SId. Reference: L3V1
   * Comp V1
   * Section 3.6.2
   */
  ...
  /**
   * Error code 1010310:
   * The value of a 'comp:conversionFactor' attribute on
   * <replacedElement> objects
   * must always conform to the syntax of the SBML data type SId. Reference:
   * L3V1
  ...
  /**
   * Error code 1010311:
   * The value of a 'comp:name' attribute must always conform to the syntax of
   * type
   ...
   * element, or whether it has a child <replacedElement>, the units of the
   * replaced
   * element, multiplied by the units of any applicable conversion factor,
   * should
  ...
  /**
   * Error code 1020101:
   * Any object derived from the extended SBase class (defined in the
   * Hierarchical
  ...
  /**
   * Error code 1020103:
   * A <listOfReplacedElements> object may have the optional attributes 'metaid'
   * and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the HierarchicalModel Composition namespace are
   * permitted on
  ...
  /**
   * Error code 1020104:
   * The <listOfReplacedElements> in an SBase object is optional, but if
   * present,
  ...
  /**
   * Error code 1020201:
   * In all SBML documents using the HierarchicalModel Composition package, the
   * SBML
  ...
  /**
   * Error code 1020202:
   * The value of attribute 'comp:required' on the SBML object must be of the
   * data
  ...
  /**
   * Error code 1020203:
   * The value of attribute 'comp:required' on the SBML object must be set to
   * 'true'
   * if the Model object within the SBML object contains any Submodel with
   * Species,
   * Parameter, Compartment, Reaction, or Event objects that have not been
   * either
   ...
   * The value of attribute 'comp:required' on the SBML object must be set to
   * 'false'
   * if the Model object within the SBML object contains no Submodel objects, or
   * if
   * all Submodel objects that are present contain no Species, Parameter,
   * Compartment, Reaction, or Event objects that have not been either directly
   * or
  ...
  /**
   * Error code 1020205:
   * There may be at most one instance of the <listOfModelDefinitions> within an
   * SBML
   ...
   * present, these container objects must not be empty. Specifically, if any of
   * the
   * following classes of objects is present within the SBML object, it must not
   * be
   * empty: <listOfModelDefinitions> and <listOfExternalModelDefinitions>.
   * Reference:
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfModelDefinitions> container may only contain
   * <modelDefinition>
  ...
  /**
   * Error code 1020209:
   * A <listOfModelDefinitions> object may have the optional attributes 'metaid'
   * and
   ...
   * <listOfExternalModelDefinitions> object. Reference: L3V1 Comp V1 Section
   * 3.3
   */
   ...
   * <listOfExternalModelDefinitions> within
   ...
   * 3
   * Core namespace are permitted on an <externalModelDefinition> object.
   * Reference:
   ...
   * Error code 1020302:
   * An <externalModelDefinition> object may have the optional SBML Level 3 Core
   * subobjects for notes and annotation. No other subobjects from the SBML
   * Level 3
   * Core namespace or the Hierarchical Model Composition namespace are
   * permitted on
   ...
   * 'comp:modelRef', and 'comp:md5'. No other attributes from the Hierarchical
   * Model
  ...
  /**
   * Error code 1020304:
   * The value of the 'comp:source' attribute on an
   ...
   * object must be the value of an id attribute on a <model>,
   * <modelDefinition>, or
   ...
   * <externalModelDefinition> object, should match the calculated MD5 checksum
   * of
   * the SBML document referenced by the 'comp:source' attribute. Reference:
   * L3V1
  ...
  /**
   * Error code 1020307:
   * The value of a 'comp:source' attribute on an
   * <externalModelDefinition> object
  ...
  /**
   * Error code 1020308:
   * The value of a comp:modelRef attribute on an
   * <externalModelDefinition> object
   * must always conform to the syntax of the SBML data type SId. Reference:
   * L3V1
   * Comp V1 Section 3.3.2
  ...
  /**
   * Error code 1020309:
   * The value of a comp:md5 attribute on an <externalModelDefinition> object
   * must
   * always conform to the syntax of type string. Reference: L3V1 Comp V1
   * Section
   * 3.3.2
   */
   ...
   * indirectly through a chain of <externalModelDefinition> objects. Reference:
   * L3V1
   * Comp V1 Section 3.3.2
   */
   ...
   * present, these container object must not be empty. Specifically, if any of
   * the
   * following classes of objects are present on the <model>, it must not be
   * empty:
  ...
  /**
   * Error code 1020506:
   * A <listOfPorts> object may have the optional attributes 'metaid' and
   * 'sboTerm'.
  ...
  /**
   * Error code 1020602:
   * A <submodel> object may have the optional SBML Level 3 Core subobjects for
   * notes
  ...
  /**
   * Error code 1020604:
   * A <listOfDeletions> container object within a <submodel> object is
   * optional, but
   ...
   * 'comp:name', 'comp:timeConversionFactor, and/or
   ...
   * conform to the syntax of the SBML data type SId. Reference: L3V1 Comp V1
   * Section
   * 3.5.1
   */
  ...
  /**
   * Error code 1020613:
   * The value of a 'comp:timeConversionFactor' attribute on a <submodel> object
   * must
   * always conform to the syntax of the SBML data type SId. Reference: L3V1
   * Comp V1
   * Section 3.5.1
  ...
  /**
   * Error code 1020614:
   * The value of a 'comp:extentConversionFactor' attribute on a
   * <submodel> object
   * must always conform to the syntax of the SBML data type SId. Reference:
   * L3V1
   ...
   * identifier
   * of a <model>, <modelDefinition>, or <externalModelDefinition> object in the
   * same
   ...
   * references that model object itself. That is, the value of a
   * 'comp:modelRef'
   ...
   * <model>
   * indirectly. That is, the 'comp:modelRef' attribute of a <submodel> may not
   * point
   * to the 'id' of a <model> containing a <submodel> object that references the
   * original <model> directly or indirectly through a chain of <model>/
   * <submodel>
   ...
   * object must be the identifier of a <parameter> object defined in the same
   * Model
   ...
   * identifier of an object contained in (that is, within the SId namespace of)
   * the
   ...
   * identifier of a <unitDefinition< object contained in the <model> referenced
   * by
  ...
  /**
   * Error code 1020704:
   * The value of a 'comp:metaIdRef' attribute on an <sBaseRef> object must be
   * the
   ...
   * <sBaseRef> must
   * point to a <submodel> object, or a <port> that itself points to a
   * <submodel>
  ...
  /**
   * Error code 1020707:
   * The value of a 'comp:idRef' attribute on an SBaseRef object must always
   * conform
   * to the syntax of the SBML data type SId. Reference: L3V1 Comp V1 Section
   * 3.7.1
   */
   ...
   * conform to the syntax of the XML data type ID. Reference: L3V1 Comp V1
   * Section
   * 3.7.1
   */
  ...
  /**
   * Error code 1020711:
   * The 'sbaseRef' spelling of an SBaseRef child of an SBaseRef object is
   * considered
   ...
   * <sBaseRef> object
   * must always have a value for one of the attributes 'comp:portRef',
   * 'comp:idRef',
   ...
   * referenced by a single <port> object; referenced by a single
   * <deletion> object;
   * referenced by a single <replacedElement>; be the parent of a single
   * <replacedBy>
   * child; be referenced by one or more <replacedBy> objects; or be referenced
   * by
   * one or more <replacedElement> objects all using the 'deletion' attribute.
   * Essentially, once an object has been referenced in one of these ways it
   * cannot
   ...
   * always have a value for one of the attributes 'comp:idRef', 'comp:unitRef',
   * or
  ...
  /**
   * Error code 1020803:
   * A <port> object must have a value for the required attribute 'comp:id', and
   * one,
   * and only one, of the attributes 'comp:idRef', 'comp:unitRef', or
   * 'comp:metaIdRef'. No other attributes from the Hierarchical Model
   * Composition
  ...
  /**
   * Error code 1020804:
   * Port definitions must be unique; that is, no two <port> objects in a given
   * Model
   * may reference the same object in that Model. Reference: L3V1 Comp V1
   * Section
   * 3.4.3
   */
  ...
  /**
   * Error code 1020901:
   * A <deletion> object must point to another object; that is, a
   * <deletion> object
   * must always have a value for one of the attributes 'comp:portRef',
   * 'comp:idRef',
   ...
   * attributes
   * 'comp:portRef', 'comp:idRef', 'comp:unitRef', and 'comp:metaIdRef'. It may
   * also
   * have the optional attributes 'comp:id' and 'comp:name'. No other attributes
   * from
  ...
  /**
   * Error code 1021002:
   * A <replacedElement> object can only point to one other object; that is, a
   * given
   ...
   * attributes: 'comp:portRef', 'comp:idRef', 'comp:unitRef', 'comp:metaIdRef',
   * or
  ...
  /**
   * Error code 1021004:
   * The value of a 'comp:submodelRef' attribute on a <replacedElement> object
   * must
  ...
  /**
   * Error code 1021005:
   * The value of a 'comp:deletion' attribute on a <replacedElement> object must
   * be
   * the identifier of a <deletion> present in the <replacedElement> object's
   * parent
  ...
  /**
   * Error code 1021011:
   * If a <replacedElement> uses the 'comp:deletion' attribute, then it should
   * not
   * also use the 'comp:conversionFactor' attribute. Reference: L3V1 Comp V1
   * Section
   * 3.6.2
   */
   ...
   * 'comp:metaIdRef'. No
   * other attributes from the HierarchicalModel Composition namespace are
   * permitted
  ...
  /**
   * Error code 1021104:
   * The value of a 'comp:submodelRef' attribute on a <replacedBy> object must
   * be the
   * identifier of a <submodel> present in the <replacedBy> object's parent
   * Model.
   ...
   * replacement element must match the SBML class of the replaced element, with
   * two
   * exceptions: an element of a derived class may replace an object of its base
   * class (for base classes other than SBase), and any SBML class with
   * mathematical
   * meaning may replace a <parameter>. A base class may not replace a derived
   * class,
   ...
   * Error code 1021202:
   * If one element replaces another, whether it is the target of a <replacedBy>
   * element, or whether it has a child <replacedElement>, if the replaced
   * element
   * has the 'id' attribute set, the replacement !element must also have the
   * 'id'
   ...
   * element, or whether it has a child <replacedElement>, if the replaced
   * element
   * has an identifier attribute from some other SBML package set, the
   * replacement
   * element must also have that same identifier attribute set. Reference: L3V1
   * Comp
   * V1 Section 3.6.5
   */
  ...
  /**
   * Error code 1090103:
   * An external model definition referenced by an external model definition in
   * this
  ...
  /**
   * Error code 1090105:
   * The interpretation the Hierarchical Model Composition constructs to produce
   * a
   * kind of 'flattened' version of the model devoid of the comp package
   * constructs
   * must produce a valid SBML Level 3 model. Reference: L3V1 Comp V1 Appendix
   * A1
   */
  public static final int COMP_90105   = 1090105;
  /**
   * Error code 1090106:
   * Due to the need to instantiate models, modelDefinitions, submodels etc. for
   * the
   * purposes of validation it is problematic to reliably report line numbers
   * when
   ...
   * function performDeletions to do so. Unfortunately, it is impossible to
   * properly
   * use this function as it was originally designed, without some models either
   * causing the program to crash, or causing them to be interpreted
   * incorrectly.
   * Instead, the software should use collectDeletionsAndDeleteCompConstructs,
   * in
   * conjunction with collectRenameAndConvertReplacements and
   * removeCollectedElements
   ...
   * impossible to properly use this function as it was originally designed,
   * without
  ...
  /**
   * Error code 1090114:
   * The model contained a deletion whose subelement was replaced. This is
   * perfectly
   * legal, but unfortunately, the subroutine used to implement this actually
   * removed
   * the deleted element and all of its children before replacing the child,
   * making
  ...
  /**
   * Error code 2010101:
   * To conform to Version 1 of the Flux Balance Constraints package
   * specification
   * for SBML Level 3, an SBML document must declare the use of the following
   * XML
   * Namespace: 'http://www.sbml.org/sbml/level3/version1/fbc/version1'
   * Reference:
   ...
   * Wherever they appear in an SBML document, elements and attributes from the
   * Flux
   * Balance Constraints package must be declared either implicitly or
   * explicitly to
   ...
   * across the set of all id and fbc:id attribute values of all such objects in
   * a
   * model: the model itself, plus all contained <functionDefinition>,
   * <compartment>,
   * <species>, <reaction>, <speciesReference>, <modifierSpeciesReference>,
   * <event>,
   * and <parameter> objects, plus the <fluxBound>, <objective>,
   * <fluxObjective>,
   * <geneProduct> and <geneProductAssociation> objects defined by the Flux
   * Balance
  ...
  /**
   * Error code 2010302:
   * The value of a fbc:id attribute must always conform to the syntax of the
   * SBML
   ...
   * object must include a value for the attribute 'fbc:required. Reference:
   * L3V1
   * Core Section 4.1.2
   */
  ...
  /**
   * Error code 2020102:
   * The value of attribute 'fbc:required' on the SBML object must be of the
   * data
   * type Boolean. Reference: L3V1 Core Section 4.1.2
   */
   ...
   * Error code 2020201:
   * There may be at most one instance of each of the following kinds of objects
   * within a <model> object using Flux Balance Constraints:
   * <listOfFluxBounds> (V1
   * only), <listOfObjectives> and <listOfGeneProducts> (V2). Reference: L3V1
   * Fbc V1
   * Section 3.3
   */
   ...
   * following classes of objects are present on the <model>, it must not be
   * empty:
   * <listOfFluxBounds> (V1 only), <listOfObjectives> and
   * <listOfGeneProducts> (V2).
   ...
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Flux Balance Constraints namespace are permitted on
   * a
   ...
   * Error code 2020206:
   * A <listOfFluxBounds> object may have the optional attributes 'metaid' and
   * 'sboTerm' defined by SBML Level 3 Core. Additionally the
   * <listOfObjectives> must
   * contain the attribute 'activeObjective'. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Flux Balance Constraints namespace are permitted on
   * a
   * <listOfFluxBounds> object. Reference: L3V1 Fbc V1 Section 3.3
  ...
  /**
   * Error code 2020207:
   * The value of attribute 'fbc:activeObjective' on the
  ...
  /**
   * Error code 2020209:
   * A <model> object must have the required attributes 'strict'. No other
   * attributes
   * from the Flux Balance Constraints namespace are permitted on a
   * <model> object.
   */
  public static final int FBC_20209    = 2020209;
  /**
   * Error code 2020210:
   * The attribute 'fbc:strict' on the <model> object must have a value of
   * datatype
   * boolean.
   */
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfGeneProducts> container object may only contain
   * <geneProduct>
   * objects.
   */
   ...
   * 'fbc:chemicalFormula'. No other attributes from the Flux Balance
   * Constraints
  ...
  /**
   * Error code 2020302:
   * The value of attribute 'fbc:charge' on SBML <species> object must be of the
   * data
  ...
  /**
   * Error code 2020303:
   * The value of attribute 'fbc:chemicalFormula' on the SBML <species> object
   * must
   * be set to a string consisting only of atomic names or user defined
   * compounds and
   ...
   * Constraints namespace are permitted on a <fluxBound> object. Reference:
   * L3V1 Fbc
   * V1 Section 3.5
   */
  ...
  /**
   * Error code 2020404:
   * The attribute 'fbc:reaction' of a <fluxBound> must be of the data type
   * SIdRef.
   ...
   * FbcOperation and thus it's value must be one of 'lessEqual', 'greaterEqual'
   * or
   ...
   * the
   * identifier of an existing <reaction> object defined in the enclosing
   * <model>
   ...
   * 'fbc:reaction'
   * must be consistent. That is while it is possible to define a lower and an
   * upper
   ...
   * 'fbc:type'
   * and may have the optional attribute 'fbc:name'. No other attributes from
   * the
   * SBML Level 3 Flux Balance Constraints namespace are permitted on an
   * <objective>
  ...
  /**
   * Error code 2020505:
   * The attribute 'fbc:type' on an <objective> must be of the data type FbcType
   * and
   * thus its value must be one of 'minimize' or 'maximize. Reference: L3V1 Fbc
   * V1,
   * Section 3.6
   */
  ...
  /**
   * Error code 2020507:
   * The <listOfFluxObjectives> subobject within an <objective> object must not
   * be
   ...
   * 'sboTerm'
   * defined by SBML Level 3 Core. No other attributes from the SBML Level 3
   * Core
  ...
  /**
   * Error code 2020602:
   * A <fluxObjective> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   * are permitted on a <fluxObjective>. Reference: L3V1 Core, Section 3.2
   ...
   * and
   * 'fbc:coefficient', and may have the optional attributes 'fbc:id' and
   * 'fbc:name'.
   * No other attributes from the SBML Level 3 Flux Balance Constraints
   * namespace are
  ...
  /**
   * Error code 2020604:
   * The attribute 'fbc:name' on a <fluxObjective> must be of the data type
   * 'string'.
   ...
   * conform to the syntax of the SBML data type 'SIdRef'. Reference: L3V1 Fbc
   * V1,
   * Section 3.7
   */
  ...
  /**
   * Error code 2020607:
   * The value of the attribute 'fbc:coefficient' of a <fluxObjective> object
   * must
   * conform to the syntax of the SBML data type 'double'. Reference: L3V1 Fbc
   * V1,
   * Section 3.7
   */
  ...
  /**
   * Error code 2020608:
   * When the value of the <model> 'fbc:strict' attribute is true, the value of
   * the
  ...
  /**
   * Error code 2020702:
   * An SBML <Reaction> object may have the optional attributes
   * 'fbc:lowerFluxBound'
   * and 'fbc:upperFluxBound'. No other attributes from the Flux Balance
   * Constraints
  ...
  /**
   * Error code 2020705:
   * The attribute 'fbc:lowerFluxBound' of a <Reaction> must point to an
   * existing
  ...
  /**
   * Error code 2020706:
   * The attribute 'fbc:upperFluxBound' of a <Reaction> must point to an
   * existing
   * <Parameter> in the model.
   */
  ...
  /**
   * Error code 2020707:
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', a
   * <Reaction>
   ...
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', the
   * <Parameter>
   * objects referred to by the attribute 'fbc:lowerFluxBound' may not have the
   * value
   * 'INF'.
   */
   ...
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', the
   * <Parameter>
   * object referred to by the attribute 'fbc:upperFluxBound' may not have the
   * value
   * '-INF'.
   */
   ...
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', the
   * <Parameter>
   * object referred to by the attribute 'fbc:lowerFluxBound' must be less than
   * or
   ...
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', the
   * 'constant'
   * attribute of <SpeciesReference> elements of a <Reaction> must be set to
   * 'true'.
   */
  public static final int FBC_20714    = 2020714;
  /**
   * Error code 2020715:
   * When the value of the <Model>s 'fbc:strict' attribute is 'true', the value
   * of a
   * <SpeciesReference>'s 'stoichiometry> attribute must not be set to 'NaN',
   * '-INF'
   * or 'INF'.
   */
   ...
   * Error code 2020802:
   * A <GeneProductAssociation> object may have the optional SBML Level 3 Core
   * subobjects for notes and annotations. No other elements from the SBML Level
   * 3
   * Core namespace are permitted on a <GeneProductAssociation.
   */
  ...
  /**
   * Error code 2020803:
   * A <GeneProductAssociation> object may have the optional attributes 'fbc:id'
   * and
   * 'fbc:name'. No other attributes from the SBML Level 3 Flux Balance
   * Constraints
  ...
  /**
   * Error code 2020804:
   * The attribute 'fbc:id' on a <GeneProductAssociation> must be of the data
   * type
   * 'SId'.
   */
  ...
  /**
   * Error code 2020805:
   * A <GeneProductAssociation> object must have one and only one of the
   * concrete
  ...
  /**
   * Error code 2020806:
   * The attribute 'fbc:name' on a <GeneProductAssociation> must be of the data
   * type
   * 'string'.
   */
  ...
  /**
   * Error code 2020903:
   * A <GeneProductRef> object must have the required attribute
   * 'fbc:geneProduct' and
  ...
  /**
   * Error code 2020904:
   * The attribute 'fbc:geneProduct' on a <GeneProductRef> must be of the data
   * type
   * 'SIdRef'.
   */
  ...
  /**
   * Error code 2020908:
   * The attribute 'fbc:geneProduct' on a <GeneProductRef> if set, must refer to
   * 'id'
  ...
  /**
   * Error code 2021001:
   * An <And> object may have the optional SBML Level 3 Core attributes 'metaid'
   * and
   * 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
   ...
   * <GeneProductRef>, <And>, or <Or>. No other elements from the SBML Level 3
   * Flux
  ...
  /**
   * Error code 2021102:
   * An <Or> object may have the optional SBML Level 3 Core subobjects for notes
   * and
   * annotations. No other elements from the SBML Level 3 Core namespace are
   * permitted on an <Or>.
   */
  ...
  /**
   * Error code 2021204:
   * The attribute 'fbc:label' on a <GeneProduct> must be of the data type
   * 'string'.
   */
  public static final int FBC_21204    = 2021204;
  /**
   * Error code 2021205:
   * The attribute 'fbc:label' on a <GeneProduct> must be unique among the set
   * of all
  ...
  /**
   * Error code 2021206:
   * The attribute 'fbc:name' on a <GeneProduct> must be of the data type
   * 'string'.
   */
  public static final int FBC_21206    = 2021206;
  /**
   * Error code 2021207:
   * The attribute 'fbc:associatedSpecies' on a <GeneProduct> must be the
   * identifier
  ...
  /**
   * Error code 3010101:
   * To conform to Version 1 of the Qualitative Models package specification for
   * SBML
   * Level 3, an SBML document must declare the use of the following XML
   * Namespace:
   * 'http://www.sbml.org/sbml/level3/version1/qual/version1' Reference: L3V1
   * Qual V1
   * Section 3.1
   */
   ...
   * Error code 3010102:
   * Wherever they appear in an SBML document, elements and attributes from the
   * Qualitative Models package must be declared either implicitly or explicitly
   * to
   * be in the XML namespace
  ...
  /**
   * Error code 3010201:
   * The MathML <math> element in a <functionTerm> object should evaluate to a
   * value
   ...
   * <csymbol> elements 'time' and 'delay' as these explicitly introduce time
   * into
   * the model. As yet time is not considered within the Qualitative Models
   * package
   ...
   * Error code 3010301:
   * (Extends validation rule #10301 in the SBML Level 3 Version 1 Core
   * specification.) Within a <model> the values of the attributes 'id' and
   * 'qual:id'
   * on every instance of the following classes of objects must be unique across
   * the
   * set of all 'id' and 'qual:id' attribute values of all such objects in a
   * model:
   * the <model> itself, plus all contained <functionDefinition>, <compartment>,
   * <species>, <reaction>, <speciesReference>, <modifierSpeciesReference>,
   * <event>,
   * and <parameter> objects, plus the <qualitativeSpecies>, <transition>,
   * <input>
   * and <output> objects defined by the Qualitative Models package. Reference:
   * L3V1
   * Qual V1 Section 3.7
   */
  ...
  /**
   * Error code 3020101:
   * In all SBML documents using the Qualitative Models package, the SBML object
   * must
   * include a value for the attribute 'qual:required' attribute. Reference:
   * L3V1
   * Core Section 4.1.2
   */
  ...
  /**
   * Error code 3020102:
   * The value of attribute 'qual:required' on the SBML object must be of the
   * data
   * type Boolean. Reference: L3V1 Core Section 4.1.2
   */
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfTransitions> container object may only contain
   * <transition>
  ...
  /**
   * Error code 3020205:
   * A <listOfQualitativeSpecies> object may have the optional 'metaid' and
   * 'sboTerm'
   * defined by SBML Level 3 Core. No other attributes from the SBML Level 3
   * Core
   ...
   * attributes
   * 'qual:name', 'qual:initialLevel' and 'qual:maxLevel'. No other attributes
   * from
  ...
  /**
   * Error code 3020304:
   * The attribute 'qual:constant' in <qualitativeSpecies> must be of the data
   * type
  ...
  /**
   * Error code 3020306:
   * The attribute 'qual:initialLevel' in <qualitativeSpecies> must be of the
   * data
  ...
  /**
   * Error code 3020307:
   * The attribute 'qual:maxLevel' in <qualitativeSpecies> must be of the data
   * type
  ...
  /**
   * Error code 3020308:
   * The value of the attribute 'qual:compartment' in a
  ...
  /**
   * Error code 3020309:
   * The value of the attribute 'qual:initialLevel' in a
   * <qualitativeSpecies> object
   * cannot be greater than the value of the 'qual:maxLevel' attribute for the
   * given
   * <qualitativeSpecies> object. Reference: L3V1 Qual V1 Section 3.5
   */
   ...
   * throughout the
   * set of transitions for the containing model. Reference: L3V1 Qual V1
   * Section
   * 3.6.2
   */
  ...
  /**
   * Error code 3020312:
   * The attribute 'qual:initialLevel' in <qualitativeSpecies> must not be
   * negative.
  ...
  /**
   * Error code 3020401:
   * A <transition> object may have the optional 'metaid' and 'sboTerm' defined
   * by
   * SBML Level 3 Core. No other attributes from the SBML Level 3 Core namespace
   * or
   ...
   * <listOfOutputs> objects from the Qualitative Models namespace. Reference:
   * L3V1
   * Qual V1 Section 3.6
   */
   ...
   * are
   * optional, but if present, these container object must not be empty.
   * Reference:
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfInputs> container object may only contain
   * <input> objects.
   * Reference: L3V1 Qual V1 Section 3.6
   */
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfOutputs> container object may only contain
   * <output> objects.
   * Reference: L3V1 Qual V1 Section 3.6
   */
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfFunctionTerms> container object must contain one and only
   * one
   ...
   * Error code 3020414:
   * No element of the <listOfFunctionTerms> object may cause the level of a
   * <qualitativeSpecies> to become negative. Reference: L3V1 Qual V1 Section
   * 3.6
   */
  public static final int QUAL_20414   = 3020414;
  /**
   * Error code 3020501:
   * An <input> object may have the optional 'metaid' and 'sboTerm' defined by
   * SBML
   * Level 3 Core. No other attributes from the SBML Level 3 Core namespace or
   * the
   * Qualitative Models namespace are permitted on an <input> object. Reference:
   * L3V1
   ...
   * notes
   * and annotations. No other elements from the SBML Level 3 Core namespaces
   * are
   ...
   * 'qual:qualitativeSpecies' as
   * well as 'qual:transitionEffect' and may have the optional attributes
   * 'qual:id',
   * 'qual:name', 'qual:sign' and 'qual:thresholdLevel'. No other attributes
   * from the
   * SBML Level 3 Qualitative Models namespace are permitted on an
   * <input> object.
  ...
  /**
   * Error code 3020505:
   * The value of the attribute 'qual:sign' of an <input> object must conform to
   * the
   * syntax of the SBML data type 'sign' and may only take on the allowed values
   * of
   * 'sign' defined in SBML; that is, the value must be one of the following:
   * 'positive', 'negative', 'dual' or 'unknown'. Reference: L3V1 Qual V1
   * Section
   * 3.6.1
   */
   ...
   * must
   * conform to the syntax of the SBML data type 'transitionInputEffect' and may
   * only
   * take on the allowed values of 'transitionInputEffect' defined in SBML; that
   * is,
   * the value must be one of the following: 'none' or 'consumption'. Reference:
   * L3V1
   * Qual V1 Section 3.6.1
   */
  ...
  /**
   * Error code 3020508:
   * The value of the attribute 'qual:qualitativeSpecies' in an <input> object
   * must
   ...
   * attribute set to 'true' cannot have the attribute 'qual:transitionEffect'
   * set to
  ...
  /**
   * Error code 3020601:
   * An <output> object may have the optional 'metaid' and 'sboTerm' defined by
   * SBML
   * Level 3 Core. No other attributes from the SBML Level 3 Core namespace or
   * the
   ...
   * 'qual:id', 'qual:name' and 'qual:outputLevel'. No other attributes from the
   * SBML
   ...
   * must
   * conform to the syntax of the SBML data type 'transitionOutputEffect' and
   * may
   * only take on the allowed values of 'transitionOutputEffect' defined in
   * SBML;
  ...
  /**
   * Error code 3020606:
   * The attribute 'qual:outputLevel' in <output> must be of the data type
   * 'integer'.
   * Reference: L3V1 Qual V1 Section 3.6.2
   */
  ...
  /**
   * Error code 3020607:
   * The value of the attribute 'qual:qualitativeSpecies' in an <output> object
   * must
   * be the identifier of an existing <qualitativeSpecies> object defined in the
   ...
   * 'qual:qualitativeSpecies'
   * in an <output> object must have the value of its 'qual:constant' attribute
   * set
  ...
  /**
   * Error code 3020609:
   * When the value of the attribute 'qual:transitionEffect' of an
   * <output> object is
  ...
  /**
   * Error code 3020701:
   * A <defaultTerm> object may have the optional 'metaid' and 'sboTerm' defined
   * by
   * SBML Level 3 Core. No other attributes from the SBML Level 3 Core namespace
   * or
  ...
  /**
   * Error code 3020801:
   * A <functionTerm> object may have the optional 'metaid' and 'sboTerm'
   * defined by
   * SBML Level 3 Core. No other attributes from the SBML Level 3 Core namespace
   * or
  ...
  /**
   * Error code 3020804:
   * A <functionTerm> object may contain exactly one MathML <math> element. No
   * other
   * elements from the SBML Level 3 Qualitative Models namespace are permitted
   * on a
  ...
  /**
   * Error code 4020101:
   * In all SBML documents using the Groups Package, the <sbml> object must have
   * the
   ...
   * <listOfGroups>
   * element. No other elements from the SBML Level 3 Groups namespaces are
   * permitted
   ...
   * present,
   * this container object must not be empty. Reference: L3V1 Groups V1 Section
   * 3.6
   */
   ...
   * SBML
   * objects, a <listOfGroups> container object may only contain
   * <group> objects.
   ...
   * 'metaid' and 'sboTerm'. No other attributes from the SBML Level 3 Core
   * namespaces are permitted on a <listOfGroups> object. Reference: L3V1 Groups
   * V1
   * Section 3.6
   */
   ...
   * have
   * the optional attributes 'groups:id' and 'groups:name'. No other attributes
   * from
   ...
   * to the
   * syntax of SBML data type 'groupKind' and may only take on the allowed
   * values of
   * 'groupKind' defined in SBML; that is, the value must be one of the
   * following:
   * 'classification', 'partonomy' or 'collection'. Reference: L3V1 Groups V1
   * Section
   * 3.3
   */
   ...
   * Apart from the general notes and annotations subobjects permitted on all
   * SBML
   * objects, a <listOfMembers> container object may only contain
   * <member> objects.
   ...
   * are
   * permitted on a <listOfMembers> object. Reference: L3V1 Groups V1 Section
   * 3.4
   */
   ...
   * elements that reference the same SBase object, the 'sboTerm' attribute and
   * any
   * child <notes> or <annotation> elements set for those <listOfMembers> should
   * be
   * consistent, as they should all apply to the same referenced object.
   * Reference:
  ...
  /**
   * Error code 4020313:
   * Member references may not be circular: no <member>'s 'idRef' or 'metaIdRef'
   * may
   * reference itself, its parent <listOfMembers>, nor its parent <group>. If a
   * <member> references a <group> or a <listOfMembers>, the same restrictions
   * apply
   * to that subgroup's children: they may not reference the <member>, its
   * parent
   * <listOfMembers>, nor its parent <group>, and if any of those children
   * reference
   * a <group>, the same restrictions apply to them, etc. Reference: L3V1 Groups
   * V1
   * Section 3.5.4
   */
   ...
   * 'groups:name'
   * and must have a value for one (and exactly one) of the attributes
   * 'groups:idRef'
   * and 'groups:metaIdRef'. No other attributes from the SBML Level 3 Groups
   * namespaces are permitted on a <member> object. Reference: L3V1 Groups V1
   * Section
   * 3.5
   */
   ...
   * the
   * 'metaid' of an existing <SBase> object defined in the enclosing
   * <model> object.
  ...
  /**
   * Error code 4020407:
   * The value of the attribute 'groups:idRef' of a <member> object must conform
   * to
   * the syntax of the SBML data type 'SId'. Reference: L3V1 Groups V1 Section
   * 3.5
   */
   ...
   * conform
   * to the syntax of the SBML data type 'ID'. Reference: L3V1 Groups V1 Section
   * 3.5
   */
  ...
  /**
   * Error code 6010101:
   * To conform to Version 1 of the Layout package specification for SBML Level
   * 3, an
   ...
   * Error code 6010102:
   * Wherever they appear in an SBML document, elements and attributes from the
   * Layout package must be declared either implicitly or explicitly to be in
   * the XML
   * namespace 'http://www.sbml.org/sbml/level3/version1/layout/version1'
   * Reference:
   ...
   * (Extends validation rule #10301 in the SBML Level 3 Version 1 Core
   * specification.) Within a <model> object the values of the attributes id and
   * layout:id on every instance of the following classes of objects must be
   * unique
   * across the set of all id and layout:id attribute values of all such objects
   * in a
   * model: the model itself, plus all contained <functionDefinition>,
   * <compartment>,
   * <species>, <reaction>, <speciesReference>, <modifierSpeciesReference>,
   ...
   * objects defined by the Layout package. Reference: L3V1 Layout V1 Section
   * 3.3
   */
  public static final int LAYOUT_10301 = 6010301;
  /**
   * Error code 6010302:
   * The value of the 'layout:id' attribute must conform to the SBML data type
   * SId
   ...
   * <cubicBezier>
   * objects. It is not permitted on any other elements from the SBML Level 3
   * Layout
  ...
  /**
   * Error code 6020101:
   * In all SBML documents using the Layout package, the SBML object must
   * include a
   * value for the attribute 'layout:required'. Reference: L3V1 Core Section
   * 4.1.2
   */
  public static final int LAYOUT_20101 = 6020101;
  /**
   * Error code 6020102:
   * The value of attribute 'layout:required' on the SBML object must be of the
   * data
   * type Boolean. Reference: L3V1 Core Section 4.1.2
   */
  ...
  /**
   * Error code 6020201:
   * There may be at most one instance of <listOfLayouts> element within a
   * <model>
  ...
  /**
   * Error code 6020202:
   * The <listOfLayouts> within a <model> object is optional, but if present,
   * this
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfLayouts> container object may only contain
   * <layout> objects.
   * Reference: L3V1 Layout V1 Section 3.5
   */
  ...
  /**
   * Error code 6020204:
   * A <listOfLayouts> object may have the optional attributes 'metaid' and
   * 'sboTerm'
   * defined by SBML Level 3 Core. No other attributes from the SBML Level 3
   * Core
   * namespace or the Layout namespace are permitted on a
   * <listOfLayouts> object.
   * Reference: L3V1 Layout V1 Section 3.5
   */
  public static final int LAYOUT_20204 = 6020204;
  /**
   * Error code 6020301:
   * A <layout> object may have the optional SBML Level 3 Core subobjects for
   * notes
   * and annotations. No other elements from the SBML Level 3 Core namespace are
  ...
  /**
   * Error code 6020302:
   * A <layout> object may have the optional SBML Level 3 Core attributes
   * 'metaid'
   * and 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
   ...
   * <listOfReactionGlyphs>, <listOfTextGlyphs>,
   ...
   * present, these container object must not be empty. Specifically, if any of
   * the
   * following classes of objects are present on the <layout>, it must not be
   * empty:
   * <listOfCompartmentGlyphs>, <listOfSpeciesGlyphs>, <listOfReactionGlyphs>,
   * <listOfTextGlyphs>, <listOfAdditionalGraphicalObjects>. Reference: L3V1
   * Layout
   * V1 Section 3.6
   */
  ...
  /**
   * Error code 6020305:
   * A <layout> object must have the required attribute 'layout:id' and may have
   * the
   * optional attribute 'layout:name'. No other attributes from the SBML Level 3
   * Layout namespace are permitted on a <layout> object. Reference: L3V1 Layout
   * V1
   * Section 3.6
   */
  ...
  /**
   * Error code 6020306:
   * The attribute 'layout:name' of a <layout> must be of the data type
   * 'string'.
   * Reference: L3V1 Layout V1 Section 3.6
   */
  ...
  /**
   * Error code 6020307:
   * A <listOfCompartmentGlyphs> object may have the optional attributes
   * 'metaid' and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
  ...
  /**
   * Error code 6020309:
   * A <listOfSpeciesGlyphs> object may have the optional attributes 'metaid'
   * and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Layout namespace are permitted on a
  ...
  /**
   * Error code 6020311:
   * A <listOfReactionGlyphs> object may have the optional attributes 'metaid'
   * and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Layout namespace are permitted on a
   ...
   * permitted on a <listOfAdditionalGraphicalObjectGlyphs> object. Reference:
   * L3V1
   ...
   * Apart from the general notes and annotation subobjects permitted on all
   * SBML
   * objects, a <listOfAdditionalGraphicalObjectGlyphs> container object may
   * only
  ...
  /**
   * Error code 6020315:
   * A <layout> object must contain exactly one <dimensions> object. Reference:
   * L3V1
   * Layout V1 Section 3.6
   */
   ...
   * subobjects
   * for notes and annotations. No other elements from the SBML Level 3 Core
   * namespace are permitted on a <graphicalObject>. Reference: L3V1 Core
   * Section 3.2
   */
   ...
   * <graphicalObject>. No other elements from the Layout namespace are
   * permitted on
  ...
  /**
   * Error code 6020404:
   * A <graphicalObject> object must have the required attribute 'layout:id' and
   * may
   * have the optional attribute 'layout:metaidRef'. No other attributes from
   * the
   * Layout namespace are permitted on a <graphicalObject>. Reference: L3V1
   * Layout V1
   * Section 3.7
   */
  ...
  /**
   * Error code 6020405:
   * The attribute 'layout:metaidRef' of a <graphicalObject> must be of the data
   * type
  ...
  /**
   * Error code 6020406:
   * The value of a 'layout:metaidRef' attribute of a <graphicalObject> must be
   * of
   * the 'metaid' of an existing element in the <model>. Reference: L3V1 Layout
   * V1
   * Section 3.7
   */
   ...
   * subobjects
   * for notes and annotations. No other elements from the SBML Level 3 Core
   * namespace are permitted on a <compartmentGlyph>. Reference: L3V1 Core
   * Section
   * 3.2
   */
   ...
   * Error code 6020503:
   * There may be at most one instance of a <boundingBox> object on a
   * <compartmentGlyph>. No other elements from the Layout namespace are
   * permitted on
  ...
  /**
   * Error code 6020504:
   * A <compartmentGlyph> object must have the required attribute 'layout:id'
   * and may
  ...
  /**
   * Error code 6020505:
   * The attribute 'layout:metaidRef' of a <compartmentGlyph> must be of the
   * data
  ...
  /**
   * Error code 6020506:
   * The value of a 'layout:metaidRef' attribute of a <compartmentGlyph> must be
   * of
   * the 'metaid' of an existing element in the <model>. Reference: L3V1 Layout
   * V1
   * Section 3.7
  ...
  /**
   * Error code 6020507:
   * The attribute 'layout:compartment' of a <compartmentGlyph> must be the data
   * type
  ...
  /**
   * Error code 6020508:
   * The value of the 'layout:compartment' attribute of a
   * <compartmentGlyph> must be
   * of the 'id' of an existing <compartment> in the <model>. Reference: L3V1
   * Layout
   * V1 Section 3.8
   */
  ...
  /**
   * Error code 6020509:
   * If both attributes 'layout:compartment' and 'layout:metaidRef' are
   * specified on
  ...
  /**
   * Error code 6020601:
   * A <speciesGlyph> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   ...
   * There may be at most one instance of a <boundingBox> object on a
   * <speciesGlyph>.
   * No other elements from the Layout namespace are permitted on a
   * <speciesGlyph>.
  ...
  /**
   * Error code 6020604:
   * A <speciesGlyph> object must have the required attribute 'layout:id' and
   * may
   * have the optional attributes 'layout:metaidRef' or 'layout:species'. No
   * other
  ...
  /**
   * Error code 6020605:
   * The attribute 'layout:metaidRef' of a <speciesGlyph> must be of the data
   * type
   * 'IDREF'. Reference: L3V1 Layout V1 Section 3.7
   */
  ...
  /**
   * Error code 6020606:
   * The value of a 'layout:metaidRef' attribute of a <speciesGlyph> must be of
   * the
  ...
  /**
   * Error code 6020608:
   * The value of the 'layout:species' attribute of a <speciesGlyph> must be of
   * the
   * 'id' of an existing <species> in the <model>. Reference: L3V1 Layout V1
   * Section
   * 3.8
   */
  ...
  /**
   * Error code 6020609:
   * If both attributes 'layout:species' and 'layout:metaidRef' are specified on
   * a
  ...
  /**
   * Error code 6020701:
   * A <reactionGlyph> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   ...
   * Error code 6020703:
   * There may be at most one instance of each of the following kinds of objects
   * within a <reactionGlyph> object: <boundingBox>, and <curve> and there must
   * be
   * one instance of the <listOfSpeciesReferenceGlyphs>. No other elements from
   * the
   * Layout namespace are permitted on a <reactionGlyph>. Reference: L3V1 Layout
   * V1
   * Section 3.10
   */
  ...
  /**
   * Error code 6020704:
   * A <reactionGlyph> object must have the required attribute 'layout:id' and
   * may
   * have the optional attributes 'layout:metaidRef' or 'layout:reaction'. No
   * other
  ...
  /**
   * Error code 6020705:
   * The attribute 'layout:metaidRef' of a <reactionGlyph> must be of the data
   * type
   * 'IDREF'. Reference: L3V1 Layout V1 Section 3.7
   */
  ...
  /**
   * Error code 6020706:
   * The value of a 'layout:metaidRef' attribute of a <reactionGlyph> must be of
   * the
   * 'metaid' of an existing element in the <model>. Reference: L3V1 Layout V1
   * Section 3.7
   */
  ...
  /**
   * Error code 6020708:
   * The value of the 'layout:reaction' attribute of a <reactionGlyph> must be
   * of the
   * 'id' of an existing <reaction> in the <model>. Reference: L3V1 Layout V1
   * Section
   * 3.10
   */
  ...
  /**
   * Error code 6020709:
   * If both attributes 'layout:reaction' and 'layout:metaidRef' are specified
   * on a
   ...
   * 'metaid' and 'sboTerm' defined by SBML Level 3 Core. No other attributes
   * from
   * the SBML Level 3 Core namespace or the Layout namespace are permitted on a
   * <listOfSpeciesReferenceGlyphs> object. Reference: L3V1 Layout V1 Section
   * 3.10
   */
  ...
  /**
   * Error code 6020801:
   * A <generalGlyph> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   ...
   * Error code 6020803:
   * There may be at most one instance of each of the following kinds of objects
   * within a <generalGlyph> object: <boundingBox>, <curve>,
   * <listOfReferenceGlyphs>
   * and <listOfSubGlyphs>. No other elements from the Layout namespace are
   * permitted
  ...
  /**
   * Error code 6020804:
   * A <generalGlyph> object must have the required attribute 'layout:id' and
   * may
   * have the optional attributes 'layout:metaidRef' or 'layout:reference'. No
   * other
  ...
  /**
   * Error code 6020805:
   * The attribute 'layout:metaidRef' of a <generalGlyph> must be of the data
   * type
   * 'IDREF'. Reference: L3V1 Layout V1 Section 3.7
   */
  ...
  /**
   * Error code 6020806:
   * The value of a 'layout:metaidRef' attribute of a <generalGlyph> must be of
   * the
   * 'metaid' of an existing element in the <model>. Reference: L3V1 Layout V1
   * Section 3.7
   */
  ...
  /**
   * Error code 6020808:
   * The value of the 'layout:reference' attribute of a <generalGlyph> must be
   * of the
   * 'id' of an existing element in the <model>. Reference: L3V1 Layout V1
   * Section
   * 3.11
   */
  ...
  /**
   * Error code 6020809:
   * If both attributes 'layout:reference' and 'layout:metaidRef' are specified
   * on a
  ...
  /**
   * Error code 6020811:
   * A <listOfReferenceGlyphs> object may have the optional attributes 'metaid'
   * and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Layout namespace are permitted on a
  ...
  /**
   * Error code 6020902:
   * A <textGlyph> object may have the optional SBML Level 3 Core attributes
   * 'metaid'
   * and 'sboTerm'. No other attributes from the SBML Level 3 Core namespace are
  ...
  /**
   * Error code 6020903:
   * A <textGlyph> must contain exactly one <boundingBox> object. No other
   * elements
   * from the Layout namespace are permitted on a <textGlyph>. Reference: L3V1
   * Layout
   * V1 Section 3.12
   */
  ...
  /**
   * Error code 6020904:
   * A <textGlyph> object must have the required attribute 'layout:id' and may
   * have
   * the optional attributes 'layout:metaidRef', 'layout:graphicalObject',
   * 'layout:text' and 'layout:originOfText'. No other attributes from the
   * Layout
   * namespace are permitted on a <textGlyph>. Reference: L3V1 Layout V1 Section
   * 3.12
   */
  ...
  /**
   * Error code 6020908:
   * The value of the 'layout:originOfText' attribute of a <textGlyph> must be
   * of the
   * 'id' of an existing element in the <model>. Reference: L3V1 Layout V1
   * Section
   * 3.12
  ...
  /**
   * Error code 6020909:
   * If both attributes 'layout:originOfText' and 'layout:metaidRef' are
   * specified on
   * a <textGlyph> they have to reference the same element in the <model>.
   * Reference:
  ...
  /**
   * Error code 6020910:
   * The attribute 'layout:graphicalObject' of a <textGlyph> must be the data
   * type
   * 'SIdRef'. Reference: L3V1 Layout V1 Section 3.12
   */
  ...
  /**
   * Error code 6020911:
   * The value of the 'layout:graphicalObject' attribute of a <textGlyph> must
   * be of
   * the 'id' of an existing <graphicalObject> (or derived) element in the
   * <layout>.
  ...
  /**
   * Error code 6020912:
   * The attribute 'layout:text' of a <textGlyph> must be the data type
   * 'string'.
   * Reference: L3V1 Layout V1 Section 3.12
   */
   ...
   * subobjects for notes and annotations. No other elements from the SBML Level
   * 3
   * Core namespace are permitted on a <speciesReferenceGlyph>. Reference: L3V1
   * Core
   * Section 3.2
   */
   ...
   * <boundingBox> and
   * <curve> object. No other elements from the Layout namespace are permitted
   * on a
   ...
   * 'layout:speciesReference' and 'layout:role'. No other attributes from the
   * Layout
   * namespace are permitted on a <speciesReferenceGlyph>. Reference: L3V1
   * Layout V1
   * Section 3.10.1
   */
  ...
  /**
   * Error code 6021005:
   * The attribute 'layout:metaidRef' of a <speciesReferenceGlyph> must be of
   * the
  ...
  /**
   * Error code 6021006:
   * The value of a 'layout:metaidRef' attribute of a
   * <speciesReferenceGlyph> must be
   * of the 'metaid' of an existing element in the <model>. Reference: L3V1
   * Layout V1
   * Section 3.7
   */
  ...
  /**
   * Error code 6021007:
   * The attribute 'layout:speciesReference' of a <speciesReferenceGlyph> must
   * be the
   ...
   * <speciesReferenceGlyph> must be of the 'id' of an existing
   * <speciesReference> in
  ...
  /**
   * Error code 6021010:
   * The attribute 'layout:speciesGlyph' of a <speciesReferenceGlyph> must be
   * the
   * data type 'SIdRef'. Reference: L3V1 Layout V1 Section 3.10.1
   */
  ...
  /**
   * Error code 6021012:
   * The attribute 'layout:role' of a <speciesReferenceGlyph> must be of data
   * type
   * 'SpeciesReferenceRole', i.e. it must have one of the following values:
   * substrate, product, sidesubstrate, sideproduct, modifier, activator,
   * inhibitor
  ...
  /**
   * Error code 6021103:
   * There may be at most one instance of a <boundingBox> and <curve> object on
   * a
   * <referenceGlyph>. No other elements from the Layout namespace are permitted
   * on a
   ...
   * namespace are permitted on a <referenceGlyph>. Reference: L3V1 Layout V1
   * Section
   * 3.11.1
   */
  ...
  /**
   * Error code 6021105:
   * The attribute 'layout:metaidRef' of a <referenceGlyph> must be of the data
   * type
   * 'IDREF'. Reference: L3V1 Layout V1 Section 3.7
   */
  ...
  /**
   * Error code 6021106:
   * The value of a 'layout:metaidRef' attribute of a <referenceGlyph> must be
   * of the
   * 'metaid' of an existing element in the <model>. Reference: L3V1 Layout V1
   * Section 3.7
   */
  ...
  /**
   * Error code 6021107:
   * The attribute 'layout:reference' of a <referenceGlyph> must be the data
   * type
  ...
  /**
   * Error code 6021108:
   * The value of the 'layout:reference' attribute of a <referenceGlyph> must be
   * of
  ...
  /**
   * Error code 6021111:
   * The value of the 'layout:glyph' attribute of a <referenceGlyph> must be of
   * the
   ...
   * notes
   * and annotations. No other elements from the SBML Level 3 Core namespace are
   * permitted on a <point>. It should be noted that the 'point' object may
   * occur as
   * a <position>, <basePoint1>, <basePoint2>, <start> or <end> element.
   * Reference:
   ...
   * attributes from the Layout namespace are permitted on a <point>. It should
   * be
   * noted that the 'point' object may occur as a <position>, <basePoint1>,
   * <basePoint2>, <start> or <end> element. Reference: L3V1 Layout V1 Section
   * 3.4.1
   */
  public static final int LAYOUT_21203 = 6021203;
  /**
   * Error code 6021204:
   * The attributes 'layout:x', 'layout:y' and 'layout:z' of a <point> element
   * must
   * be of the data type 'double'. It should be noted that the 'point' object
   * may
   * occur as a <position>, <basePoint1>, <basePoint2>, <start> or
   * <end> element.
  ...
  /**
   * Error code 6021301:
   * A <boundingBox> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
  ...
  /**
   * Error code 6021303:
   * There must be exactly one instance of a <point> and a <dimensions> object
   * on a
   * <boundingBox>. No other elements from the Layout namespace are permitted on
   * a
  ...
  /**
   * Error code 6021304:
   * A <boundingBox> object may have the optional attributes 'layout:id'. No
   * other
   ...
   * noted that the 'point' object will occur as a <position> element.
   * Reference:
   * L3V1 Layout V1 Section 3.7
   */
   ...
   * <curve>. No other elements from the Layout namespace are permitted on a
   * <curve>.
  ...
  /**
   * Error code 6021404:
   * No attributes from the Layout namespace are permitted on a <curve>.
   * Reference:
  ...
  /**
   * Error code 6021405:
   * A <listOfCurveSegments> object may have the optional attributes 'metaid'
   * and
   * 'sboTerm' defined by SBML Level 3 Core. No other attributes from the SBML
   * Level
   * 3 Core namespace or the Layout namespace are permitted on a
  ...
  /**
   * Error code 6021501:
   * A <lineSegment> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   * are permitted on a <lineSegment>. It should be noted that a 'lineSegment'
   * occurs
   * as a <curveSegment> element with type 'LineSegment' or 'CubicBezier'.
   * Reference:
   * L3V1 Core Section 3.2
   */
  ...
  /**
   * Error code 6021503:
   * A <lineSegment> must specify two <point> elements 'start' and 'end'. No
   * other
   * elements from the Layout namespace are permitted on a <lineSegment>. It
   * should
  ...
  /**
   * Error code 6021504:
   * No attributes from the Layout namespace are permitted on a <lineSegment>.
   * It
   * should be noted that a 'lineSegment' occurs as a <curveSegment> element
   * with
   * type 'LineSegment' or 'CubicBezier'. Reference: L3V1 Layout V1 Section
   * 3.4.5
   */
  public static final int LAYOUT_21504 = 6021504;
  /**
   * Error code 6021601:
   * A <cubicBezier> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
  ...
  /**
   * Error code 6021701:
   * A <dimensions> object may have the optional SBML Level 3 Core subobjects
   * for
   * notes and annotations. No other elements from the SBML Level 3 Core
   * namespace
   ...
   * 'layout:depth'. No other attributes from the Layout namespace are permitted
   * on a
   ...
   * <dimensions> element must be of the data type 'double'. Reference: L3V1
   * Layout
   * V1 Section 3.4.2
   */
