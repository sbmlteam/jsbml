...
/**
 * Search recursively an {@link XMLNode} tree to find any {@link XMLNode} with a certain local name 
 * and namespace. It is a bit equivalent to the DOM method {@link Element#getElementsByTagNameNS(String, String)}.
 * 
