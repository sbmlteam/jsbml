...
/**
 * Defines the methods necessary for an {@link org.sbml.jsbml.ASTNode} or
 * {@link org.sbml.jsbml.math.ASTNode2} Plugin. When a SBML Level 3 is
...
public interface ASTNodePlugin extends TreeNodeWithChangeSupport {
   ...
   *
   * @return {@code true} if an extended TreeNode has been set.
   */
