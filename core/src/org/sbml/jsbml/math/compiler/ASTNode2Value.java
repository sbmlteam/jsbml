...
/**
 * When interpreting {@link ASTNode2}s, the {@link ASTNode2Compiler} takes
 ...
 * tells the {@link ASTNode2Compiler} which operation was performed to obtain the
 ...
 * @date Aug 2, 2014
 */
public class ASTNode2Value {
  
  /**
   * An {@link ASTNode2Compiler} that is needed in the case that this
   * {@link ASTNode2Value} contains a derivative of
  ...
  private int level;
  /**
   * The type of the underlying {@link ASTNode2}.
   */
  private Type type;
  /**
   * Flag to indicate whether the underlying {@link ASTNode2} was an unary
   * node.
   */
   ...
   * @param value
   */
  public ASTNode2Value(boolean value, ASTNode2Compiler compiler) {
    this(compiler);
   ...
   * @param value
   */
  public ASTNode2Value(double value, ASTNode2Compiler compiler) {
    this(compiler);
   ...
   * @param value
   */
  public ASTNode2Value(float value, ASTNode2Compiler compiler) {
    this(compiler);
   ...
   * @param compiler
   */
  public ASTNode2Value(long value, ASTNode2Compiler compiler) {
    this(compiler);
   ...
   * @param value
   */
  public ASTNode2Value(int value, ASTNode2Compiler compiler) {
    this(compiler);
   ...
   * @param value
   */
  public ASTNode2Value(CallableSBase value,
   ...
   * @param compiler
   */
  public ASTNode2Value(Node node, ASTNode2Compiler compiler) {
    this(compiler);
    setValue(node);
  }
   ...
   * @param value
   */
  public ASTNode2Value(Number value, ASTNode2Compiler compiler) {
    this(compiler);
    setValue(value);
  }
   ...
   * @param value
   */
  public ASTNode2Value(String value, ASTNode2Compiler compiler) {
    this(compiler);
    setValue(value);
  }
   ...
   *         {@link ASTNode2Compiler} associated with this object compiles this
   *         value to an {@link ASTNode2Value} that contains a boolean or at
