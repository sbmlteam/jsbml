...
/*
 * $Id: FormulaParserLL3.java 2095 2014-12-04 15:05:58Z kofiav $
 * $URL: svn://svn.code.sf.net/p/jsbml/code/branches/jsbml-1.0-ASTNode2/core/src/org/sbml/jsbml/math/parser/FormulaParserLL3.java $
 * ----------------------------------------------------------------------------
 ...
 */
  ...
  ArrayList < ASTNode > arguments = new ArrayList < ASTNode > ();
    ...
    else if (s.equals("sqr"))
    {
      ...
      node = new ASTNode(Type.FUNCTION_ROOT);
      node.addChild(child);
    ...
    vector = new ASTNode(Type.VECTOR);
