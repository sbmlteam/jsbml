/*
 * $Id:  ASTCnNumberNode.java 12:14:04 PM victor-kofia $
 * $URL: https://svn.code.sf.net/p/jsbml/code/trunk/core/src/org/sbml/jsbml/math/ASTCnNumberNode.java $
 * ---------------------------------------------------------------------------- 
...
public class ASTCnNumberNode extends ASTNumber {
  ...
  /**
   * Set the type of the MathML element represented by this ASTCiNumberNode
   * 
   * @param String type
   */
  ...
  /**
   * Set the units of the MathML element represented by this ASTCiNumberNode
   * 
   * @param String units
   */
