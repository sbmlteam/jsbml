...
public class FormulaParserLL3 implements IFormulaParser, FormulaParserLL3Constants {
  ...
  ArrayList < ASTNode > arguments = new ArrayList < ASTNode > ();
    ...
    {
      {if (true) throw new RuntimeException("Invalid configuration file entries in file " + Resource.class.getResource(path), e);}
    }
    catch (IOException e)
    {
  ...
  static {
   ...
   private static void jj_la1_init_0() {
      jj_la1_0 = new int[] {0x600000,0x2000001,0x200,0x1800,0x1800,0x18500,0x18500,0x80,0x68,0x702400,};
   }
