...
public interface ReadingParser {
   ...
   * For example, if the contextObject is an instance of Reaction and the
   ...
   * {@link org.sbml.jsbml.Reaction} instance.
   * 
   * @param elementName
   ...
   * consequence. For example, if the contextObject is an instance of
   ...
   * For example, if the contextObject is an instance of SBMLDocument, the
   ...
   * For example, if the contextObject is an instance of Event and the
