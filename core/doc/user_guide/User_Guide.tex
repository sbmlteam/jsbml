...
{Alex Thomas} {Alexander D\"orr} {Clemens Wrzodek} {Finja B\"uchel}
...
\author{%
  ...
  \begin{tabular}{@{}c>{\hspace*{18pt}}cc@{}}
    ...
    Andreas Dr\"ager\where{a,b} & Nicolas Rodriguez\where{c,d} & Marine Dumousseau\where{d}\\
    Alex Thomas\where{a} & Alexander D\"orr\where{b} & Clemens Wrzodek\where{b}\\
