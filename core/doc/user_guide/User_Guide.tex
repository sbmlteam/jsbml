...
\hypersetup{
  ...
  pdfauthor={Andreas Dr\"ager} {Nicolas Rodriguez} {Marine Dumousseau} {Alexander D\"orr} {Clemens Wrzodek} {Finja B\"uchel} {Florian Mittag} {Nicolas Le Nov{\`e}re} {Andreas Zell} {Michael Hucka},
...
\author{%
  ...
  \begin{tabular}{@{}c>{\hspace*{18pt}}cc@{}}
    ...
    Andreas Dr\"ager\aff{a} & Nicolas Rodriguez\aff{b} & Marine Dumousseau\aff{b} \\
    Alexander D\"orr\aff{a} & Clemens Wrzodek\aff{a}   & Finja B\"uchel\aff{a} \\
    Florian Mittag\aff{a}   & Michael Hucka\aff{c}     & \\[2em]
    \divider{Principal investigators}\\[0.75em]
    Nicolas Le Nov\`ere\aff{b} & Andreas Zell\aff{a}   & Michael Hucka\aff{c} \\[2em]
    \divider{Institutional affiliations}\\[0.45em]
  \end{tabular}
  \\
  \aff{a\,}Center for Bioinformatics T\"ubingen\\
  University of T\"ubingen\\
  T\"ubingen, Germany
  \\[1.5em]
  \aff{b\,}European Bioinformatics Institute\\
  Wellcome Trust Genome Campus\\
  Hinxton, Cambridge, UK
  \\[1.5em]
  \aff{c\,}Computing and Mathematical Sciences\\
