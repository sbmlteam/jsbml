...
using JSBML. But we also provide some programming examples and hints about how
to use and work with JSBML. You will also have an overview about the type hierarchy 
and API of JSBML, not necessarily only important for people coming from libSBML.
