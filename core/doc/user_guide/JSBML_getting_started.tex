...
\begin{table}[b]
  ...
  \begin{tabular}{>{\ttfamily}lp{2.26in}l}
    ...
    & biojava3 ontology-related classes~\citep{Holland2008}.
    \index{Ontology}
...
\url{https://code.google.com/p/spi/wiki/EclipseSettings}. If you checkout 
...
%% TODO - add few words about the tidy writer module
