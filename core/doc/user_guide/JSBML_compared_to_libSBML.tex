...
\begin{figure}[htb]
  \exampleFile{src/org/sbml/jsbml/xml/libsbml/libSBMLio_example.java}
...
\begin{figure}[thb]
  \exampleFile{src/org/sbml/jsbml/celldesigner/cdplugin_example.java}
...
\begin{figure}[thb]
  \exampleFile[style = java, lastline = 66]{src/org/sbml/jsbml/celldesigner/SimpleCellDesignerPlugin.java}
...
\begin{figure}[thb]
  \exampleFile[style = java, firstline = 67]{src/org/sbml/jsbml/celldesigner/SimpleCellDesignerPlugin.java}
