...
/**
 * tests FbcV1ToCobraConverter
 * 
 * @author Thomas Hamm
 * @author Nicolas Rodriguez
 * @since 1.3
 */
public class TestFbcV1ToCobraConverter {

  /**
   * Converts SBML FBC_V1 files to old COBRA SBML files.
   * 
  ...
  public static void main(String[] args) throws XMLStreamException, IOException {
    ...
    tidySBMLWriter.writeSBMLToFile(fbcV1ToCobraConverter.convert(doc),args[1]);
  }
}
