...
\includegraphics[width=\textwidth]{../../../extensions/qual/doc/img/type_hierarchy.pdf}
 ...
 \caption[Class diagram of the qualitative models extension]{Class diagram of
   ...
   package (\code{qual}, for short) allows species in a model to have
...
\begin{figure}[H]
 \vspace*{-1em}
 \centering
\includegraphics[scale=0.65]{../../../extensions/groups/doc/img/type_hierarchy.pdf}
 \vspace*{-3em}
 \caption[Class diagram of the groups extension]{Class diagram of the groups
   extension. The SBML Level~3 \code{Groups} package is a simple facility
   that allows a modeler to indicate relationships between elements in an
   SBML model. Coupling \code{groups} information with annotation and SBO
...
\includegraphics[width=\textwidth]{../../../extensions/fbc/doc/img/type_hierarchy.pdf}
 ...
 \caption[Class diagram of the flux balance constraints extension.]{Class
   ...
   (\code{fbc}, \cite{olivier2013}) enable a constraints based
   ...
   which optimizes the reaction fluxes. Therefore, the \code{fbc} package
...
\begin{figure}[H]
 \centering
\includegraphics[scale=0.65]{../../../extensions/req/doc/img/type_hierarchy.pdf}
 \vspace*{-3em}
...
\begin{figure}[H]
 \centering
\includegraphics[scale=0.65]{../../../extensions/distrib/doc/img/type_hierarchy.pdf}
 \vspace*{-3em}
...
\begin{figure}[H]
 \vspace*{-2em}
 \centering
\includegraphics[scale=0.65]{../../../extensions/dyn/doc/img/type_hierarchy.pdf}
 \vspace*{-4em}
...
\begin{figure}[H]
 \vspace*{-3em}
 \centering
\includegraphics[scale=0.55]{../../../extensions/render/doc/img/type_hierarchy.pdf}
 \vspace*{-3em}
