...
\begin{figure}[ht]
  \exampleFile[firstline=35,caption={}]{src/org/sbml/jsbml/gui/JSBMLvisualizer.java}
...
\begin{figure}[bht]
  \vspace*{-1ex}
  \exampleFile[firstline=32,caption={}]{src/org/sbml/jsbml/demo/JSBMLexample.java}
  \vspace*{-1.5ex}
