...
interface.  The interface \UniqueNamedSBase is shared by those elements whose
...
SBML data structure.  This is require because in JSBML, the \Model object
stores direct pointers in the form of a hash from the identifier of the
corresponding object if \code{isIdMandatory()} returns \code{true}. The
