...
\texttt{InitialAssignment} class to make sure that switching from LibSBML to
JSBML is quite smoothly. However, the preferred way in JSBML is to
apply the methods \texttt{setVariable} either with String or Variable instances
as arguments.
...
\verb!String!s according to the specification of SBML Level 1 into an abstract
syntax tree.
...
Programming Interface). The Listings~\vrefrange{lst:PluginAction}{lst:Plugin}
