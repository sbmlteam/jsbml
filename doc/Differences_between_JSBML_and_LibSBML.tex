...
re-implement the existing Java API of libSBML\index{Application programming
interface!libSBML} \citep{Bornstein2008}.
...
programming interface!JSBML} has become quite complex (see
...
1 and 2\index{SBML!Level~1} \texttt{Event}s could be
