...
This directory contains the modules of JSBML 0.8. 
Here you will find the following: 

  jsbml-celldesigner-1.0.jar  -- jar file containing the classes of the 
  celldesigner module.

  jsbml-libSBMLio-0.8.15.jar  -- jar file containing the classes of the 
  libSBMLio module.
