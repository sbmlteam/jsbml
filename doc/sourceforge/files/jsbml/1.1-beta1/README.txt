...
This is the top-level directory of the JSBML 1.1 beta1 release. Here you
will find the following:

  jsbml-1.1-b1.jar  -- jar file containing the classes of JSBML-1.1-b1
  
  jsbml-1.1-b1-with-dependencies.jar  -- jar file containing the
  classes of JSBML-1.1-b1 including all of the currently supported
  SBML L3 packages and any needed dependencies libraries classes.
  
  jsbml-1.1-b1-full.zip  -- full distribution of JSBML-1.1-b1
