...
will find the following:
  ...
  jsbml-1.0-b1.jar  -- jar file containing the classes of JSBML-1.0-beta1
  
  jsbml-1.0-b1-with-dependencies.jar  -- jar file containing the
  ...
  jsbml-1.0-b1-full.zip  -- full distribution of JSBML-1.0-beta1
...
Please note: some of the code for the SBML Level 3 packages reflects the current
