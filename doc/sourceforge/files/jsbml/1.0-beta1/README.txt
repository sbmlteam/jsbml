...
This is the top-level directory of the JSBML 1.0-beta1 release. Here you
will find the following:

  jsbml-1.0-beta1.jar  -- jar file containing the classes of JSBML-1.0-beta1
  
  jsbml-1.0-beta1-with-dependencies.jar  -- jar file containing the
  classes of JSBML-1.0-beta1 including all of the currently supported
  SBML L3 packages and any needed dependencies libraries classes.
  
  jsbml-1.0-beta1-full.zip  -- full distribution of JSBML-1.0-beta1
  ...
  jsbml-1.0-beta1-full.tar.gz  -- same content as jsbml-1.0-beta1-full.zip

Please note: the code for the SBML Level 3 packages reflects the current
state of development of each packages. Many of the SBML Level 3 package
specifications have not yet been finalized, and the package implementations
are themselves in a state of development. The code available may be untested
and is supplied 'as-is' for experimental development only.
