...
will find the following:
  ...
  jsbml-1.0-beta1-with-dependencies.jar  -- jar file containing the classes of
  JSBML-1.0-beta1 including all of the currently supported SBML L3 packages
  and any needed dependencies libraries classes.
  
  jsbml-1.0-beta1-full.zip  -- full distribution of JSBML-1.0-beta1 containing the 
