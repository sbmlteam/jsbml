...
This is the top-level directory of the JSBML 1.0-rc1 release. Here you
will find the following:

  jsbml-1.0-rc1.jar  -- jar file containing the classes of JSBML-1.0-rc1
  
  jsbml-1.0-rc1-with-dependencies.jar  -- jar file containing the
  classes of JSBML-1.0-rc1 including all of the currently supported
  SBML L3 packages and any needed dependencies libraries classes.
  
  jsbml-1.0-rc1-full.zip  -- full distribution of JSBML-1.0-rc1
