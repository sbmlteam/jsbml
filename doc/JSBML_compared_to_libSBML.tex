...
In addition, the compatibility module of JSBML mimics the package structure of
libSBML and provides identically named classes. In this way, it is possible to
