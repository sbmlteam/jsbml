...
(meaning info, warn, error and fatal), will be printe on the console.
...
% TODO : remove line numbers on the listings
...
\begin{lstlisting}[language=sh,numbers=none,caption={A simple log4j
example.},label=lst:log4j1]
...
file.
\begin{lstlisting}[language=sh,numbers=none,caption={SMTPAppender log4j
example.}, label=lst:log4j2]
...
\texttt{libSBMLio} privies the classes \texttt{LibSBMLReader}
