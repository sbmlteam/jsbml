...
\begin{lstlisting}[language=bash,numbers=none,caption={A simple  log4j example.},
label=lst:log4j1]
...
Using XML instead of a properties file to define the log4j configuration, you can even send
