...
define a tree, in which each element has exactly one parental node. It is
important to note that some properties of the elements must not be copied when
cloning:
\begin{enumerate}
  ...
  linked again to an existing tree somehow, but cloning the parent could lead
  to an infinite loop.
  \item The list of
