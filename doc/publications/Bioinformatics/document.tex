...
When building JSBML, the latest SBO OBO export can directly be downloaded and parsed
\citep{Holland2008}.
...
SBMLsqueezer \citep{Draeger2008} and Biomodels Database \citep{Li2010} have 
already been released using JSBML and many other projects are planned.
