 ...
 * @date Jun 10, 2014
 */
public class CellDesignerModelConverter extends SwingWorker<SBMLDocument, Throwable> {
   ...
   * @param selectedModel
   */
  public CellDesignerModelConverter(PluginSBMLReader reader, PluginModel selectedModel) {
    sbmlReader=reader;
