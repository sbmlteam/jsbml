...
public class XMLAttributes {
	 ...
	 * 
	 * @param sb
	 *            a reference to an object to which the current object instance
	 *            will be compared
	 * 
	 * @return <code>true</code> if <code>sb</code> refers to the same
	 *         underlying native object as this one, <code>false</code>
	 *         otherwise
	 */
	...
	public int hashCode() {
		...
		for (int i = 0; i < attributeNames.size(); i++) {
			hashcode += attributeNames.get(i).hashCode()
					+ attributeValues.get(i).hashCode();
		}
	...
	/**
	 * Adds an attribute (a name/value pair) to this {@link XMLAttributes} set
	 ...
	 *         possible values returned by this function are: <li>
	 *         JSBML_OPERATION_SUCCESS
	 *         <p>
	...
	/**
	 * Adds an attribute with the given {@link XMLTriple}/value pair to this
	 * {@link XMLAttributes} set.
	 * <p>
	 * 
	 * @note if local name with the same namespace URI already exists in this
	 *       attribute set, its value and prefix will be replaced.
	 *       <p>
	 * @param triple
	 *            an {@link XMLTriple}, the XML triple of the attribute.
	 * @param value
	 *            a string, the value of the attribute.
	 *            <p>
	 * @return integer value indicating success/failure of the function. The
	...
	/**
	 * Removes an attribute with the given index from this {@link XMLAttributes}
	 * set.
	 * <p>
	 * 
	 * @param n
	 ...
	 * @return integer value indicating success/failure of the function. The
	 *         possible values returned by this function are: <li>
	 *         JSBML_OPERATION_SUCCESS <li>JSBML_INDEX_EXCEEDS_SIZE
	 */
	...
	/**
	 * Removes an attribute with the given index from this {@link XMLAttributes}
	 * set. (This function is an alias of XMLAttributes.removeResource() ).
	 * <p>
	 * 
	 * @param n
	 *            an integer the index of the resource to be deleted
	...
	/**
	 * Removes an attribute with the given local name and name space URI from
	 ...
	 *            a string, the local name of the attribute.
	 * @param uri
	 *            a string, the name space URI of the attribute.
	 *            <p>
	 * @return integer value indicating success/failure of the function. The
	 *         possible values returned by this function are: <li>
	 *         JSBML_OPERATION_SUCCESS <li>LIBSBML_OPERATION_FAILED;
	 */
	public int remove(String name, String uri) {
		...
		if (index != -1) {
			...
			return JSBML.LIBSBML_OPERATION_FAILED;
		}
	...
	/**
	 * Removes an attribute with the given local name from this
	 * {@link XMLAttributes} set.
	 * <p>
	 * 
	 * @param name
	...
	/**
	 * Removes an attribute with the given {@link XMLTriple} from this
	 * {@link XMLAttributes} set.
	 * <p>
	 * 
	 * @param triple
	 ...
	 *       Thus, if there are multiple attributes with the given local name
	 *       and different namespaces, the smallest index among those attributes
	 *       will be returned.
	 *       {@link XMLAttributes#getIndex(String name, String uri)} or
	 *       {@link XMLAttributes#getIndex(XMLTriple triple)} should be used to
	 *       get an index of an attribute with the given local name and
	 *       namespace.
	 *       <p>
	 * @param name
	 *            a string, the local name of the attribute for which the index
	 *            is required.
	 *            <p>
	 * @return the index of an attribute with the given local name, or -1 if not
	 *         present.
	 */
	...
	/**
	 * Returns the index of an attribute with the given local name and namespace
	 * URI.
	 * <p>
	 * 
	 * @param name
	 ...
	 *            a string, the namespace URI of the attribute.
	 *            <p>
	 * @return the index of an attribute with the given local name and namespace
	 *         URI, or -1 if not present.
	 */
	 ...
	 * 
	 * @param triple
	 *            an {@link XMLTriple}, the XML triple of the attribute for
	 *            which the index is required.
	 *            <p>
	 * @return the index of an attribute with the given {@link XMLTriple}, or -1
	 *         if not present.
	 */
	...
	/**
	 * Returns the local name of an attribute in this {@link XMLAttributes} set
	 * (by position).
	 * <p>
	 * 
	 * @param index
	 ...
	 *       {@link XMLAttributes#hasAttribute(int index)} to test for the
	 *       attribute existence.
	 */
	...
	/**
	 * Returns the prefix of an attribute in this {@link XMLAttributes} set (by
	 * position).
	 * <p>
	 * 
	 * @param index
	...
	/**
	 * Returns the prefixed name of an attribute in this {@link XMLAttributes}
	 * set (by position).
	 * <p>
	 * 
	 * @param index
	 *            an integer, the position of the attribute whose prefixed name
	 *            is required.
	 *            <p>
	 * @return the prefixed name of an attribute in this list (by position).
	 *         <p>
	 * @note If index is out of range, an empty string will be returned. Use
	 *       {@link XMLAttributes#hasAttribute(int index)} to test for attribute
	 *       existence.
	 */
	public String getPrefixedName(int index) {
		...
		return triple.getPrefix().length() == 0 ? triple.getName() : triple
				.getPrefix()
				+ ":" + triple.getName();
	...
	/**
	 * Returns the namespace URI of an attribute in this {@link XMLAttributes}
	 * set (by position).
	 * <p>
	 * 
	 * @param index
	 *            an integer, the position of the attribute whose namespace URI
	 *            is required.
	 *            <p>
	...
	/**
	 * Returns the value of an attribute in this {@link XMLAttributes} set (by
	 * position).
	 * <p>
	 * 
	 * @param index
	 ...
	 * 
	 * @param name
	 *            a string, the local name of the attribute whose value is
	 *            required.
	 *            <p>
	 * @return The attribute value as a string.
	 *         <p>
	 * @note If an attribute with the given local name does not exist, an empty
	 *       string will be returned. Use
	 *       {@link XMLAttributes#hasAttribute(String name, String uri)} to test
	 *       for attribute existence. A namespace bound to the local name is not
	 *       checked by this function. Thus, if there are multiple attributes
	 ...
	 *       returned. {@link XMLAttributes#getValue(String name)} or
	 *       {@link XMLAttributes#getValue(XMLTriple triple)} should be used to
	 *       get a value of an attribute with the given local name and
	 *       namespace.
	 */
	...
	/**
	 * Returns a value of an attribute with the given local name and namespace
	 * URI.
	 * <p>
	 * 
	 * @param name
	 ...
	 * 
	 * @param triple
	 *            an {@link XMLTriple}, the XML triple of the attribute whose
	 *            value is required.
	 *            <p>
	 * @return The attribute value as a string.
	 *         <p>
	 ...
	 *       {@link XMLAttributes#hasAttribute(XMLTriple triple)} to test for
	 *       attribute existence.
	 */
	...
	/**
	 * Returns <code>true</code> or <code>false</code> depending on whether an
	 * attribute with the given index exists in this {@link XMLAttributes}.
	 * <p>
	 * 
	 * @param index
	 *            an integer, the position of the attribute.
	 *            <p>
	 * @return <code>true</code> if an attribute with the given index exists in
	 *         this {@link XMLAttributes}, <code>false</code> otherwise.
	 */
	...
	/**
	 * Returns <code>true</code> or <code>false</code> depending on whether an
	 * attribute with the given local name and namespace URI exists in this
	 * {@link XMLAttributes}.
	 * <p>
	 * 
	 * @param name
	 ...
	 *         namespace URI exists in this {@link XMLAttributes},
	...
	/**
	 * Returns <code>true</code> or <code>false</code> depending on whether an
	 * attribute with the given local name exists in this {@link XMLAttributes}.
	 * <p>
	 * 
	 * @param name
	 *            a string, the local name of the attribute.
	 ...
	 *         exists in this {@link XMLAttributes}, <code>false</code>
	 *         otherwise.
	 */
	...
	/**
	 * Returns <code>true</code> or <code>false</code> depending on whether an
	 * attribute with the given XML triple exists in this {@link XMLAttributes}.
	 * <p>
	 * 
	 * @param triple
	 *            an {@link XMLTriple}, the XML triple of the attribute
	 *            <p>
	 * @return <code>true</code> if an attribute with the given XML triple
	 *         exists in this {@link XMLAttributes}, <code>false</code>
	 *         otherwise.
	 *         <p>
	 */
	 ...
	 * {@link XMLAttributes} set is empty.
	 * <p>
	 * 
	 * @return <code>true</code> if this {@link XMLAttributes} set is empty,
	 *         <code>false</code> otherwise.
	 */
