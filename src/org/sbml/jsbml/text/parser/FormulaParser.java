...
public class FormulaParser implements FormulaParserConstants {
  ...
  ArrayList < ASTNode > arguments = new ArrayList < ASTNode > ();
    ...
    try
    {
      stringToType.loadFromXML(Resource.class
      .getResourceAsStream(path));
    }
    catch (InvalidPropertiesFormatException e)
    {
      {if (true) throw new RuntimeException(
      "Invalid configuration file entries in file "
      + Resource.class.getResource(path), e);}
    }
    catch (IOException e)
    {
      {if (true) throw new RuntimeException(
      "Could not read configuration file " + Resource.class.getResource(path), e);}
    }
